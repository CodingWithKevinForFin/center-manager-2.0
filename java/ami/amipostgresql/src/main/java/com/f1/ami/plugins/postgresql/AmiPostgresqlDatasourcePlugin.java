...
public class AmiPostgresqlDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "POSTGRES";
	private static final String DATASOURCE_DESC = "Postgres JDBC";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "server_address:port_number/database_name", AmiDatasourcePlugin.HELP_GENERAL,
			"postgres general help");
	private static final Map<String, String> OPTIONS_MAP = AmiPostgresqlDatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiPostgresqlDatasourceAdapter();
	}
