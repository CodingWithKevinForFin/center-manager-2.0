...
public class AmiWebStyleTypeImpl_FormDateField extends AmiWebStyleType {

	private static final String TYPE = "formDateField";
	public static final AmiWebStyleTypeImpl_FormDateField INSTANCE = new AmiWebStyleTypeImpl_FormDateField();

	public AmiWebStyleTypeImpl_FormDateField() {
		super(TYPE, "Form Date Field", AmiWebStyleTypeImpl_Field.TYPE_FIELD);
		addFieldFields(true);
		startGroup("Calendar");
