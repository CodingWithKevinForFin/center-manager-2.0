...
public class MultiCheckboxFieldEditFormPortlet extends BaseEditFieldPortlet<MultiCheckboxQueryField> {
	...
	public MultiCheckboxFieldEditFormPortlet(AmiWebFormFieldFactory<MultiCheckboxQueryField> factory, AmiWebQueryFormPortlet queryFormPortlet, int fieldX, int fieldY) {
		super(factory, queryFormPortlet, fieldX, fieldY);
		FormPortlet settingsForm = getSettingsForm();
		FormPortletTitleField titleField = settingsForm.addField(new FormPortletTitleField("Multi Checkbox Field Options"));
	...
	@Override
	public void readFromField(MultiCheckboxQueryField field) {
	...
	@Override
	public void writeToField(MultiCheckboxQueryField queryField) {
