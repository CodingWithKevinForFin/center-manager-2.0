...
public class AmiWebRealtimeProcessorPlugin_BPIPE implements AmiWebRealtimeProcessorPlugin {

	public static final String PLUGIN_ID = "BPIPE";
	...
	public AmiWebRealtimeProcessor create(AmiWebService service) {
		return new AmiWebRealtimeProcessor_BPIPE(service);
	}
	...
	public void startWizard(AmiWebService service) {
		Portlet p = new AmiWebRealtimeProcessorWizard_BPIPE(service.getPortletManager().generateConfig());
		service.getPortletManager().showDialog("Create Realtime Bpipe Processor ", p);
	}
	...
	public void starEditWizard(AmiWebService service, AmiWebRealtimeProcessor target) {
		Portlet p = new AmiWebRealtimeProcessorWizard_BPIPE(service.getPortletManager().generateConfig(), target);
	...
	public AmiWebRealtimeProcessor create(AmiWebService service, String fullAlias) {
		return new AmiWebRealtimeProcessor_BPIPE(service, fullAlias);
	}
