...
public class MultiSelectFieldEditFormPortlet extends BaseEditFieldPortlet<MultiSelectQueryField> {
	...
	public MultiSelectFieldEditFormPortlet(AmiWebFormMultiSelectFieldFactory factory, AmiWebQueryFormPortlet queryFormPortlet, int fieldX, int fieldY) {
	...
	@Override
	public void readFromField(MultiSelectQueryField field) {
	...
	@Override
	public void writeToField(MultiSelectQueryField queryField) {
