...
public class AmiWebStyleTypeImpl_FormDateRangeField extends AmiWebStyleType {

	private static final String TYPE = "formDateRangeField";
	public static final AmiWebStyleTypeImpl_FormDateRangeField INSTANCE = new AmiWebStyleTypeImpl_FormDateRangeField();

	public AmiWebStyleTypeImpl_FormDateRangeField() {
		super(TYPE, "Form Date Range Field", AmiWebStyleTypeImpl_Field.TYPE_FIELD);
		addFieldFields(true);
		startGroup("Calendar");
