...
public class AmiDb2DatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "IBMDB2";
	private static final String DATASOURCE_DESC = "IBM DB2";
	...
	private static final Map<String, String> OPTIONS_MAP = AmiDb2DatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiDb2DatasourceAdapter();
	}
