...
public class AmiSybaseIqDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "SYBASE_IQ";
	private static final String DATASOURCE_DESC = "Sybase IQ JDBC";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "server_address:port_number", AmiDatasourcePlugin.HELP_GENERAL,
			"sybase iq general help");

	private static final Map<String, String> OPTIONS_MAP = AmiSybaseDatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiSybaseIqDatasourceAdapter();
	}
