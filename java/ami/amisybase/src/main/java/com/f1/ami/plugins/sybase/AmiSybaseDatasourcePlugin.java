...
public class AmiSybaseDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "SYBASE";
	private static final String DATASOURCE_DESC = "Sybase JDBC";
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiSybaseDatasourceAdapter();
	}
