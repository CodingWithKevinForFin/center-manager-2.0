...
public class AmiSqlServerDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "SQLSERVER";
	private static final String DATASOURCE_DESC = "SQLServer JDBC";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "server_address:port_number/database_name", AmiDatasourcePlugin.HELP_GENERAL,
			"sql server general help");

	private static final Map<String, String> OPTIONS_MAP = AmiSqlServerDatasourceAdapter.buildOptions();
	...
	@Override
	public AmiSqlServerDatasourceAdapter createDatasourceAdapter() {
		return new AmiSqlServerDatasourceAdapter();
	}
