...
public class AmiSftpDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "SFTP";
	private static final String DATASOURCE_DESC = "SFTP";
	...
	@Override
	public AmiSftpDatasourceAdapter createDatasourceAdapter() {
		return new AmiSftpDatasourceAdapter();
	}
