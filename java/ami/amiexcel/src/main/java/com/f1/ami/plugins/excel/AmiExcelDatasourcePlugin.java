...
public class AmiExcelDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "MSEXCEL";
	private static final String DATASOURCE_DESC = "MS Excel";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "/path/to/directory/containing/files", AmiDatasourcePlugin.HELP_GENERAL,
			"excel general help");
	private static final Map<String, String> OPTIONS_MAP = AmiExcelDatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiExcelDatasourceAdapter();
	}
