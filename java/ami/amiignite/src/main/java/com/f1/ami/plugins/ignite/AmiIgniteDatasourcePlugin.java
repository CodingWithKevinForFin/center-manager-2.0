...
public class AmiIgniteDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "IGNITE";
	private static final String DATASOURCE_DESC = "IGNITE JDBC";
	...
	private static final Map<String, String> OPTIONS_MAP = AmiIgniteDatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiIgniteDatasourceAdapter();
	}
