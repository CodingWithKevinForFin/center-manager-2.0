...
public class AmiBloombergDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "Bloomberg";
	private static final String DATASOURCE_DESC = "Bloomberg";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "host:port", AmiDatasourcePlugin.HELP_GENERAL, "bloomberg general help");
	private static final Map<String, String> OPTIONS_MAP = AmiBloombergDatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiBloombergDatasourceAdapter();
	}
