...
public class AmiImpalaDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "IMPALA";
	private static final String DATASOURCE_DESC = "Apache Impala";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "server_address:port_number/database_name;AuthMech=#", AmiDatasourcePlugin.HELP_GENERAL,
			"impala general help");

	private static final Map<String, String> OPTIONS_MAP = AmiImpalaDatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiImpalaDatasourceAdapter();
	}
