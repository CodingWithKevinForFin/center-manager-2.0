...
public class AmiSqLiteDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "SQLITE";
	private static final String DATASOURCE_DESC = "SQLITE JDBC";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "sqllite_database_filepath", AmiDatasourcePlugin.HELP_GENERAL, "sqlite general help");

	private static final Map<String, String> OPTIONS_MAP = AmiSqLiteDatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiSqLiteDatasourceAdapter();
	}
