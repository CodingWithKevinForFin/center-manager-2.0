...
public class AmiRedisDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "Redis";
	private static final String DATASOURCE_DESC = "Redis";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "server_address:port",
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiRedisDatasourceAdapter();
	}
