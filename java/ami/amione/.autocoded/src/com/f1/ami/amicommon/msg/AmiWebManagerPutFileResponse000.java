...
public  class AmiWebManagerPutFileResponse000 extends com.f1.ami.amicommon.msg.AmiWebManagerPutFileResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public void setReturnFlag(java.lang.Boolean _returnFlag){
	    super.setReturnFlag(_returnFlag);
	    existing.set(6,true);
    }
    public boolean askExistsReturnFlag(){
	...
	public AmiWebManagerPutFileResponse000 nw(){
	    return new AmiWebManagerPutFileResponse000();
	}

	public AmiWebManagerPutFileResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiWebManagerPutFileResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getReturnFlag(),session);
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 2:
                    ...
                    this.setReturnFlag((java.lang.Boolean)converter.read(session));
