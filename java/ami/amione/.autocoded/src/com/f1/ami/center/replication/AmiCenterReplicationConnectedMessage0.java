...
public abstract class AmiCenterReplicationConnectedMessage0 implements com.f1.ami.center.replication.AmiCenterReplicationConnectedMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,Cloneable{
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterReplicationConnectedMessage0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_centerId extends AbstractValuedParam<AmiCenterReplicationConnectedMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterReplicationConnectedMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterReplicationConnectedMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterReplicationConnectedMessage0 valued) {
		    return (byte)((AmiCenterReplicationConnectedMessage0)valued).getCenterId();
	    }
    
	    @Override
	    public void setValue(AmiCenterReplicationConnectedMessage0 valued, Object value) {
		    valued.setCenterId((java.lang.Byte)value);
	    }
    
	    @Override
	    public void copy(AmiCenterReplicationConnectedMessage0 source, AmiCenterReplicationConnectedMessage0 dest) {
		    dest.setCenterId(source.getCenterId());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterReplicationConnectedMessage0 source, AmiCenterReplicationConnectedMessage0 dest) {
	    ...
	    @Override
	    public byte getByte(AmiCenterReplicationConnectedMessage0 valued) {
		    return valued.getCenterId();
	    }
    
	    @Override
	    public void setByte(AmiCenterReplicationConnectedMessage0 valued, byte value) {
	    ...
	    @Override
	    public void append(AmiCenterReplicationConnectedMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getCenterId());
	        
	    }
	    @Override
	    public void append(AmiCenterReplicationConnectedMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiCenterReplicationConnectedMessage0 valued){
