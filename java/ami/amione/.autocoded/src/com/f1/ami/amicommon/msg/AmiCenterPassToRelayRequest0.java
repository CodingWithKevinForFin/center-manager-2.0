...
public abstract class AmiCenterPassToRelayRequest0 implements com.f1.ami.amicommon.msg.AmiCenterPassToRelayRequest ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private com.f1.ami.amicommon.msg.AmiRelayRequest _agentRequest;
    ...
    private long _relayMiid;

    private long _requestTime;

    private static final String NAMES[]={ "agentRequest" ,"comment","invokedBy","priority","relayMiid","requestTime"};
    ...
    public void put(String name, Object value){//asdf
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "relayMiid" || name.equals("relayMiid")) {this._relayMiid=(java.lang.Long)value;return;}
break;
                case 2:
...
break;
                case 8:
                    ...
                    if(name == "agentRequest" || name.equals("agentRequest")) {this._agentRequest=(com.f1.ami.amicommon.msg.AmiRelayRequest)value;return;}
break;
                case 9:
    ...
    public boolean putNoThrow(String name, Object value){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "relayMiid" || name.equals("relayMiid")) {this._relayMiid=(java.lang.Long)value;return true;}
break;
                case 2:
...
break;
                case 8:
                    ...
                    if(name == "agentRequest" || name.equals("agentRequest")) {this._agentRequest=(com.f1.ami.amicommon.msg.AmiRelayRequest)value;return true;}
break;
                case 9:
    ...
    public Object ask(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "relayMiid" || name.equals("relayMiid")) {return OH.valueOf(this._relayMiid);}
...
break;
                case 8:
                    ...
                    if(name == "agentRequest" || name.equals("agentRequest")) {return this._agentRequest;}
    ...
    public Class askClass(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "relayMiid" || name.equals("relayMiid")) {return long.class;}
break;
                case 2:
...
break;
                case 8:
                    ...
                    if(name == "agentRequest" || name.equals("agentRequest")) {return com.f1.ami.amicommon.msg.AmiRelayRequest.class;}
break;
                case 9:
    ...
    public ValuedParam askValuedParam(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "relayMiid" || name.equals("relayMiid")) {return VALUED_PARAM_relayMiid;}
break;
                case 2:
...
break;
                case 8:
                    ...
                    if(name == "agentRequest" || name.equals("agentRequest")) {return VALUED_PARAM_agentRequest;}
break;
                case 9:
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "relayMiid" || name.equals("relayMiid")) {return 4;}
break;
                case 2:

                    if(name == "requestTime" || name.equals("requestTime")) {return 5;}
break;
                case 4:

                    if(name == "priority" || name.equals("priority")) {return 3;}
break;
                case 7:
...
break;
                case 8:
                    ...
                    if(name == "agentRequest" || name.equals("agentRequest")) {return 0;}
break;
                case 9:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterPassToRelayRequest0.class;
	}
    ...
    public boolean askParamValid(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "relayMiid" || name.equals("relayMiid")) {return true;}
break;
                case 2:
...
break;
                case 8:
                    ...
                    if(name == "agentRequest" || name.equals("agentRequest")) {return true;}
break;
                case 9:
    ...
    public byte askBasicType(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "relayMiid" || name.equals("relayMiid")) {return 6;}
break;
                case 2:
...
break;
                case 8:
                    ...
                    if(name == "agentRequest" || name.equals("agentRequest")) {return 41;}
break;
                case 9:
...
break;
    ...
    public Object askAtPosition(int position){
        ...
        case 0:return _agentRequest;

        case 1:return _comment;

        case 2:return _invokedBy;

        case 3:return _priority;

        case 4:return _relayMiid;

        case 5:return _requestTime;

        }
        throw new IndexOutOfBoundsException("supplied position > param count: "+position+" >= "+ 6);
    }

    public com.f1.ami.amicommon.msg.AmiRelayRequest getAgentRequest(){
        return this._agentRequest;
    }
    public void setAgentRequest(com.f1.ami.amicommon.msg.AmiRelayRequest _agentRequest){
    ...
    public long getRelayMiid(){
        return this._relayMiid;
    }
    public void setRelayMiid(long _relayMiid){
    
        this._relayMiid=_relayMiid;
    }
    ...
    private static final class VALUED_PARAM_CLASS_agentRequest extends AbstractValuedParam<AmiCenterPassToRelayRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterPassToRelayRequest0 valued, DataOutput stream) throws IOException{
		    
		       throw new IOException("can not write to type to dataStream: com.f1.ami.amicommon.msg.AmiRelayRequest}");
		    
	    }
	    
	    @Override
	    public void read(AmiCenterPassToRelayRequest0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayRequest0 valued) {
		    return (com.f1.ami.amicommon.msg.AmiRelayRequest)((AmiCenterPassToRelayRequest0)valued).getAgentRequest();
	    }
    
	    @Override
	    public void setValue(AmiCenterPassToRelayRequest0 valued, Object value) {
		    valued.setAgentRequest((com.f1.ami.amicommon.msg.AmiRelayRequest)value);
	    }
    
	    @Override
	    public void copy(AmiCenterPassToRelayRequest0 source, AmiCenterPassToRelayRequest0 dest) {
		    dest.setAgentRequest(source.getAgentRequest());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterPassToRelayRequest0 source, AmiCenterPassToRelayRequest0 dest) {
	        return OH.eq(dest.getAgentRequest(),source.getAgentRequest());
	    }
	    ...
	    public Class getReturnType() {
		    return com.f1.ami.amicommon.msg.AmiRelayRequest.class;
	    }
	    private static final Caster CASTER=OH.getCaster(com.f1.ami.amicommon.msg.AmiRelayRequest.class);
	    @Override
	    ...
	    @Override
	    public void append(AmiCenterPassToRelayRequest0 valued, StringBuilder sb){
	        
	        sb.append(valued.getAgentRequest());
	        
	    }
	    @Override
	    public void append(AmiCenterPassToRelayRequest0 valued, StringBuildable sb){
	    ...
	    public String toString(){
	        return "ValuedParam:com.f1.ami.amicommon.msg.AmiRelayRequest agentRequest";
	    }
	    @Override
	    public void clear(AmiCenterPassToRelayRequest0 valued){
	       valued.setAgentRequest(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_agentRequest=new VALUED_PARAM_CLASS_agentRequest();
  

  
    private static final class VALUED_PARAM_CLASS_comment extends AbstractValuedParam<AmiCenterPassToRelayRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayRequest0 valued) {
		    return (java.lang.String)((AmiCenterPassToRelayRequest0)valued).getComment();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_invokedBy extends AbstractValuedParam<AmiCenterPassToRelayRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayRequest0 valued) {
		    return (java.lang.String)((AmiCenterPassToRelayRequest0)valued).getInvokedBy();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiCenterPassToRelayRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayRequest0 valued) {
		    return (int)((AmiCenterPassToRelayRequest0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiCenterPassToRelayRequest0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiCenterPassToRelayRequest0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_relayMiid extends AbstractValuedParam<AmiCenterPassToRelayRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    public void write(AmiCenterPassToRelayRequest0 valued, DataOutput stream) throws IOException{
		      ...
		      stream.writeLong(valued.getRelayMiid());
	    ...
	    public void read(AmiCenterPassToRelayRequest0 valued, DataInput stream) throws IOException{
		      ...
		      valued.setRelayMiid(stream.readLong());
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayRequest0 valued) {
		    return (long)((AmiCenterPassToRelayRequest0)valued).getRelayMiid();
	    }
    
	    @Override
	    public void setValue(AmiCenterPassToRelayRequest0 valued, Object value) {
		    valued.setRelayMiid((java.lang.Long)value);
	    }
    
	    @Override
	    public void copy(AmiCenterPassToRelayRequest0 source, AmiCenterPassToRelayRequest0 dest) {
		    dest.setRelayMiid(source.getRelayMiid());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterPassToRelayRequest0 source, AmiCenterPassToRelayRequest0 dest) {
	        return OH.eq(dest.getRelayMiid(),source.getRelayMiid());
	    }
	    ...
	    @Override
	    public long getLong(AmiCenterPassToRelayRequest0 valued) {
		    return valued.getRelayMiid();
	    }
    
	    @Override
	    public void setLong(AmiCenterPassToRelayRequest0 valued, long value) {
		    valued.setRelayMiid(value);
	    }
	    ...
	    @Override
	    public String toString(){
	        return "ValuedParam:long relayMiid";
	    }
	    @Override
	    public void clear(AmiCenterPassToRelayRequest0 valued){
	       valued.setRelayMiid(0L);
	    }
	};
    private static final ValuedParam VALUED_PARAM_relayMiid=new VALUED_PARAM_CLASS_relayMiid();
  

  
    private static final class VALUED_PARAM_CLASS_requestTime extends AbstractValuedParam<AmiCenterPassToRelayRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayRequest0 valued) {
		    return (long)((AmiCenterPassToRelayRequest0)valued).getRequestTime();
	    }
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_agentRequest, VALUED_PARAM_comment, VALUED_PARAM_invokedBy, VALUED_PARAM_priority, VALUED_PARAM_relayMiid, VALUED_PARAM_requestTime, };



    private static final byte PIDS[]={ 1 ,52,51,53,4,54};
    
    @Override
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             case 1: return VALUED_PARAM_agentRequest;
             case 52: return VALUED_PARAM_comment;
             case 51: return VALUED_PARAM_invokedBy;
             case 53: return VALUED_PARAM_priority;
             case 4: return VALUED_PARAM_relayMiid;
    ...
    public Class askClass(byte pid){
        switch(pid){
             case 1: return com.f1.ami.amicommon.msg.AmiRelayRequest.class;
    ...
    public void put(byte pid,Object value){
        try{
        switch(pid){
             case 1: this._agentRequest=(com.f1.ami.amicommon.msg.AmiRelayRequest)value;return;
             ...
             case 4: this._relayMiid=(java.lang.Long)value;return;
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             case 1: this._agentRequest=(com.f1.ami.amicommon.msg.AmiRelayRequest)value;return true;
             ...
             case 4: this._relayMiid=(java.lang.Long)value;return true;
    ...
    public void putLong(byte pid,long value){
        ...
        switch(pid){
             case 4: this._relayMiid=value;return;
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 1:
            ...
            this._agentRequest=(com.f1.ami.amicommon.msg.AmiRelayRequest)converter.read(session);
...
if(this._agentRequest!=null && (0 & transience)==0){
    out.writeByte(1);
        
    converter.write(this._agentRequest,session);
        
}

if(this._relayMiid!=0L && (0 & transience)==0){
    out.writeByte(4);
        
    out.writeByte(6);
    out.writeLong(this._relayMiid);
