...
public abstract class AmiRelayConnectionMessage0 implements com.f1.ami.amicommon.msg.AmiRelayConnectionMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private java.lang.String _remoteIp;

    private int _remotePort;

    private byte _transformState;

    private static final String NAMES[]={ "appIdStringKey" ,"connectionId","connectionTime","origSeqNum","params","remoteIp","remotePort","transformState"};
...
break;
                case 5:
                    ...
                    if(name == "remoteIp" || name.equals("remoteIp")) {this._remoteIp=(java.lang.String)value;return;}
break;
                case 6:
...
break;
                case 10:
                    ...
                    if(name == "connectionTime" || name.equals("connectionTime")) {this._connectionTime=(java.lang.Long)value;return;}
break;
                case 12:
...
break;
                case 5:
                    ...
                    if(name == "remoteIp" || name.equals("remoteIp")) {this._remoteIp=(java.lang.String)value;return true;}
break;
                case 6:
...
break;
                case 10:
                    ...
                    if(name == "connectionTime" || name.equals("connectionTime")) {this._connectionTime=(java.lang.Long)value;return true;}
break;
                case 12:
...
break;
                case 5:
                    ...
                    if(name == "remoteIp" || name.equals("remoteIp")) {return this._remoteIp;}
...
break;
                case 10:
                    ...
                    if(name == "connectionTime" || name.equals("connectionTime")) {return OH.valueOf(this._connectionTime);}
...
break;
                case 5:
                    ...
                    if(name == "remoteIp" || name.equals("remoteIp")) {return java.lang.String.class;}
break;
                case 6:
...
break;
                case 10:
                    ...
                    if(name == "connectionTime" || name.equals("connectionTime")) {return long.class;}
break;
                case 12:
...
break;
                case 5:
                    ...
                    if(name == "remoteIp" || name.equals("remoteIp")) {return VALUED_PARAM_remoteIp;}
break;
                case 6:
...
break;
                case 10:
                    ...
                    if(name == "connectionTime" || name.equals("connectionTime")) {return VALUED_PARAM_connectionTime;}
break;
                case 12:
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 1:
                    ...
                    if(name == "remotePort" || name.equals("remotePort")) {return 6;}
break;
                case 2:
...
break;
                case 5:
                    ...
                    if(name == "remoteIp" || name.equals("remoteIp")) {return 5;}
break;
                case 6:
...
break;
                case 10:
                    ...
                    if(name == "connectionTime" || name.equals("connectionTime")) {return 2;}
break;
                case 12:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiRelayConnectionMessage0.class;
	}
...
break;
                case 5:
                    ...
                    if(name == "remoteIp" || name.equals("remoteIp")) {return true;}
break;
                case 6:
...
break;
                case 10:
                    ...
                    if(name == "connectionTime" || name.equals("connectionTime")) {return true;}
break;
                case 12:
...
break;
                case 5:
                    ...
                    if(name == "remoteIp" || name.equals("remoteIp")) {return 20;}
break;
                case 6:
...
break;
                case 10:
                    ...
                    if(name == "connectionTime" || name.equals("connectionTime")) {return 6;}
break;
                case 12:
...
break;
    ...
    public Object askAtPosition(int position){
        ...
        case 2:return _connectionTime;

        case 3:return _origSeqNum;

        case 4:return _params;

        case 5:return _remoteIp;

        case 6:return _remotePort;
    ...
    public void setConnectionTime(long _connectionTime){
    ...
    public void setRemoteIp(java.lang.String _remoteIp){
    ...
    private static final class VALUED_PARAM_CLASS_appIdStringKey extends AbstractValuedParam<AmiRelayConnectionMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiRelayConnectionMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiRelayConnectionMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiRelayConnectionMessage0 valued) {
		    return (short)((AmiRelayConnectionMessage0)valued).getAppIdStringKey();
	    }
    
	    @Override
	    public void setValue(AmiRelayConnectionMessage0 valued, Object value) {
		    valued.setAppIdStringKey((java.lang.Short)value);
	    }
    
	    @Override
	    public void copy(AmiRelayConnectionMessage0 source, AmiRelayConnectionMessage0 dest) {
		    dest.setAppIdStringKey(source.getAppIdStringKey());
	    }
	    
	    @Override
	    public boolean areEqual(AmiRelayConnectionMessage0 source, AmiRelayConnectionMessage0 dest) {
	    ...
	    @Override
	    public short getShort(AmiRelayConnectionMessage0 valued) {
		    return valued.getAppIdStringKey();
	    }
    
	    @Override
	    public void setShort(AmiRelayConnectionMessage0 valued, short value) {
	    ...
	    @Override
	    public void append(AmiRelayConnectionMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getAppIdStringKey());
	        
	    }
	    @Override
	    public void append(AmiRelayConnectionMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiRelayConnectionMessage0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_connectionId extends AbstractValuedParam<AmiRelayConnectionMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayConnectionMessage0 valued) {
		    return (int)((AmiRelayConnectionMessage0)valued).getConnectionId();
	    }
	    ...
	    @Override
	    public int getInt(AmiRelayConnectionMessage0 valued) {
		    return valued.getConnectionId();
	    }
    
	    @Override
	    public void setInt(AmiRelayConnectionMessage0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_connectionTime extends AbstractValuedParam<AmiRelayConnectionMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    public void write(AmiRelayConnectionMessage0 valued, DataOutput stream) throws IOException{
		      ...
		      stream.writeLong(valued.getConnectionTime());
	    ...
	    public void read(AmiRelayConnectionMessage0 valued, DataInput stream) throws IOException{
		      ...
		      valued.setConnectionTime(stream.readLong());
	    ...
	    @Override
	    public Object getValue(AmiRelayConnectionMessage0 valued) {
		    return (long)((AmiRelayConnectionMessage0)valued).getConnectionTime();
	    }
    
	    @Override
	    public void setValue(AmiRelayConnectionMessage0 valued, Object value) {
		    valued.setConnectionTime((java.lang.Long)value);
	    }
    
	    @Override
	    public void copy(AmiRelayConnectionMessage0 source, AmiRelayConnectionMessage0 dest) {
		    dest.setConnectionTime(source.getConnectionTime());
	    }
	    
	    @Override
	    public boolean areEqual(AmiRelayConnectionMessage0 source, AmiRelayConnectionMessage0 dest) {
	        return OH.eq(dest.getConnectionTime(),source.getConnectionTime());
	    }
	    ...
	    @Override
	    public long getLong(AmiRelayConnectionMessage0 valued) {
		    return valued.getConnectionTime();
	    }
    
	    @Override
	    public void setLong(AmiRelayConnectionMessage0 valued, long value) {
		    valued.setConnectionTime(value);
	    }
	    ...
	    public void append(AmiRelayConnectionMessage0 valued, StringBuilder sb){
	        ...
	        sb.append(valued.getConnectionTime());
	    ...
	    @Override
	    public String toString(){
	        return "ValuedParam:long connectionTime";
	    }
	    @Override
	    public void clear(AmiRelayConnectionMessage0 valued){
	       valued.setConnectionTime(0L);
	    }
	};
    private static final ValuedParam VALUED_PARAM_connectionTime=new VALUED_PARAM_CLASS_connectionTime();
  

  
    private static final class VALUED_PARAM_CLASS_origSeqNum extends AbstractValuedParam<AmiRelayConnectionMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayConnectionMessage0 valued) {
		    return (long)((AmiRelayConnectionMessage0)valued).getOrigSeqNum();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_params extends AbstractValuedParam<AmiRelayConnectionMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayConnectionMessage0 valued) {
		    return (byte[])((AmiRelayConnectionMessage0)valued).getParams();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_remoteIp extends AbstractValuedParam<AmiRelayConnectionMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayConnectionMessage0 valued) {
		    return (java.lang.String)((AmiRelayConnectionMessage0)valued).getRemoteIp();
	    }
    
	    @Override
	    public void setValue(AmiRelayConnectionMessage0 valued, Object value) {
		    valued.setRemoteIp((java.lang.String)value);
	    }
    
	    @Override
	    public void copy(AmiRelayConnectionMessage0 source, AmiRelayConnectionMessage0 dest) {
		    dest.setRemoteIp(source.getRemoteIp());
	    }
	    
	    @Override
	    public boolean areEqual(AmiRelayConnectionMessage0 source, AmiRelayConnectionMessage0 dest) {
	        return OH.eq(dest.getRemoteIp(),source.getRemoteIp());
	    }
	    ...
	    public void append(AmiRelayConnectionMessage0 valued, StringBuilder sb){
	           ...
	           SH.quote('"',valued.getRemoteIp(),sb);
	    ...
	    @Override
	    public String toString(){
	        return "ValuedParam:java.lang.String remoteIp";
	    }
	    @Override
	    public void clear(AmiRelayConnectionMessage0 valued){
	       valued.setRemoteIp(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_remoteIp=new VALUED_PARAM_CLASS_remoteIp();
  

  
    private static final class VALUED_PARAM_CLASS_remotePort extends AbstractValuedParam<AmiRelayConnectionMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayConnectionMessage0 valued) {
		    return (int)((AmiRelayConnectionMessage0)valued).getRemotePort();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_transformState extends AbstractValuedParam<AmiRelayConnectionMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayConnectionMessage0 valued) {
		    return (byte)((AmiRelayConnectionMessage0)valued).getTransformState();
	    }
	    ...
	    @Override
	    public byte getByte(AmiRelayConnectionMessage0 valued) {
		    return valued.getTransformState();
	    }
    
	    @Override
	    public void setByte(AmiRelayConnectionMessage0 valued, byte value) {
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_appIdStringKey, VALUED_PARAM_connectionId, VALUED_PARAM_connectionTime, VALUED_PARAM_origSeqNum, VALUED_PARAM_params, VALUED_PARAM_remoteIp, VALUED_PARAM_remotePort, VALUED_PARAM_transformState, };



    private static final byte PIDS[]={ 44 ,10,11,45,4,9,12,46};
    ...
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             ...
             case 11: return VALUED_PARAM_connectionTime;
             case 45: return VALUED_PARAM_origSeqNum;
             case 4: return VALUED_PARAM_params;
             case 9: return VALUED_PARAM_remoteIp;
             case 12: return VALUED_PARAM_remotePort;
    ...
    public Object ask(byte pid){
        switch(pid){
             ...
             case 11: return  OH.valueOf(this._connectionTime); 
             case 45: return  OH.valueOf(this._origSeqNum); 
             case 4: return  this._params; 
             case 9: return  this._remoteIp; 
             case 12: return  OH.valueOf(this._remotePort); 
    ...
    public void put(byte pid,Object value){
        ...
        switch(pid){
             ...
             case 11: this._connectionTime=(java.lang.Long)value;return;
             case 45: this._origSeqNum=(java.lang.Long)value;return;
             case 4: this._params=(byte[])value;return;
             case 9: this._remoteIp=(java.lang.String)value;return;
             case 12: this._remotePort=(java.lang.Integer)value;return;
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             ...
             case 11: this._connectionTime=(java.lang.Long)value;return true;
             case 45: this._origSeqNum=(java.lang.Long)value;return true;
             case 4: this._params=(byte[])value;return true;
             case 9: this._remoteIp=(java.lang.String)value;return true;
             case 12: this._remotePort=(java.lang.Integer)value;return true;
    ...
    public int askInt(byte pid){
        switch(pid){
             ...
             case 12: return this._remotePort;
    ...
    public long askLong(byte pid){
        switch(pid){
             case 11: return this._connectionTime;
    ...
    public void putInt(byte pid,int value){
        ...
        switch(pid){
             ...
             case 12: this._remotePort=value;return;
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid for int value").set("class",askSchema().askOriginalType().getName());
        }
    }
    ...
    public void putLong(byte pid,long value){
        ...
        switch(pid){
             case 11: this._connectionTime=value;return;
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 9:
            ...
            this._remoteIp=(java.lang.String)converter.read(session);
        ...
        case 11:
            ...
            if((basicType=in.readByte())!=6)
                break;
            this._connectionTime=in.readLong();
...
if(this._remoteIp!=null && (0 & transience)==0){
    out.writeByte(9);
        
    converter.write(this._remoteIp,session);
...
if(this._connectionTime!=0L && (0 & transience)==0){
    out.writeByte(11);
        
    out.writeByte(6);
    out.writeLong(this._connectionTime);
