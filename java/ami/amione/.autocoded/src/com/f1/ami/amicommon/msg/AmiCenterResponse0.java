...
public abstract class AmiCenterResponse0 implements com.f1.ami.amicommon.msg.AmiCenterResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterResponse0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_exception extends AbstractValuedParam<AmiCenterResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterResponse0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterResponse0 valued) {
		    return (java.lang.Exception)((AmiCenterResponse0)valued).getException();
	    }
    
	    @Override
	    public void setValue(AmiCenterResponse0 valued, Object value) {
		    valued.setException((java.lang.Exception)value);
	    }
    
	    @Override
	    public void copy(AmiCenterResponse0 source, AmiCenterResponse0 dest) {
		    dest.setException(source.getException());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterResponse0 source, AmiCenterResponse0 dest) {
	    ...
	    @Override
	    public void append(AmiCenterResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getException());
	        
	    }
	    @Override
	    public void append(AmiCenterResponse0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiCenterResponse0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiCenterResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterResponse0 valued) {
		    return (java.lang.String)((AmiCenterResponse0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_ok extends AbstractValuedParam<AmiCenterResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterResponse0 valued) {
		    return (boolean)((AmiCenterResponse0)valued).getOk();
	    }
	    ...
	    @Override
	    public boolean getBoolean(AmiCenterResponse0 valued) {
		    return valued.getOk();
	    }
    
	    @Override
	    public void setBoolean(AmiCenterResponse0 valued, boolean value) {
		    valued.setOk(value);
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiCenterResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterResponse0 valued) {
		    return (int)((AmiCenterResponse0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiCenterResponse0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiCenterResponse0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_progress extends AbstractValuedParam<AmiCenterResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterResponse0 valued) {
		    return (double)((AmiCenterResponse0)valued).getProgress();
	    }
	    ...
	    @Override
	    public double getDouble(AmiCenterResponse0 valued) {
		    return valued.getProgress();
	    }
    
	    @Override
	    public void setDouble(AmiCenterResponse0 valued, double value) {
    ...
    private static final class VALUED_PARAM_CLASS_ticket extends AbstractValuedParam<AmiCenterResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterResponse0 valued) {
		    return (java.lang.String)((AmiCenterResponse0)valued).getTicket();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_trackedEvents extends AbstractValuedParam<AmiCenterResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterResponse0 valued) {
		    return (java.util.List)((AmiCenterResponse0)valued).getTrackedEvents();
	    }
