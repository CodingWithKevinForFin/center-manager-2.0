...
public abstract class AmiCenterGetResourceRequest0 implements com.f1.ami.amicommon.msg.AmiCenterGetResourceRequest ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private java.util.List _paths;

    private static final String NAMES[]={ "paths" };
    ...
    public void put(String name, Object value){//asdf
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "paths" || name.equals("paths")) {this._paths=(java.util.List)value;return;}
break;
        }
    ...
    public boolean putNoThrow(String name, Object value){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "paths" || name.equals("paths")) {this._paths=(java.util.List)value;return true;}
break;
        }
        return false;
    }
    ...
    public Object ask(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "paths" || name.equals("paths")) {return this._paths;}
    ...
    public Class askClass(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "paths" || name.equals("paths")) {return java.util.List.class;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public ValuedParam askValuedParam(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "paths" || name.equals("paths")) {return VALUED_PARAM_paths;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "paths" || name.equals("paths")) {return 0;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterGetResourceRequest0.class;
	}
    ...
    public boolean askParamValid(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "paths" || name.equals("paths")) {return true;}
break;
        }
        return false;
    }
    ...
    public byte askBasicType(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "paths" || name.equals("paths")) {return 21;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public void setPaths(java.util.List _paths){
    ...
    private static final class VALUED_PARAM_CLASS_paths extends AbstractValuedParam<AmiCenterGetResourceRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterGetResourceRequest0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterGetResourceRequest0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterGetResourceRequest0 valued) {
		    return (java.util.List)((AmiCenterGetResourceRequest0)valued).getPaths();
	    }
    
	    @Override
	    public void setValue(AmiCenterGetResourceRequest0 valued, Object value) {
		    valued.setPaths((java.util.List)value);
	    }
    
	    @Override
	    public void copy(AmiCenterGetResourceRequest0 source, AmiCenterGetResourceRequest0 dest) {
		    dest.setPaths(source.getPaths());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterGetResourceRequest0 source, AmiCenterGetResourceRequest0 dest) {
	        return OH.eq(dest.getPaths(),source.getPaths());
	    }
	    ...
	    @Override
	    public void append(AmiCenterGetResourceRequest0 valued, StringBuilder sb){
	        
	        sb.append(valued.getPaths());
	        
	    }
	    @Override
	    public void append(AmiCenterGetResourceRequest0 valued, StringBuildable sb){
	    ...
	    public String toString(){
	        return "ValuedParam:java.util.List paths";
	    }
	    @Override
	    public void clear(AmiCenterGetResourceRequest0 valued){
	       valued.setPaths(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_paths=new VALUED_PARAM_CLASS_paths();
  


    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_paths, };
    ...
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             case 1: return VALUED_PARAM_paths;
    ...
    public byte askPid(String name){
             if(name=="paths") return 1;
            
             if("paths".equals(name)) return 1;
            throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public void put(byte pid,Object value){
        try{
        switch(pid){
             case 1: this._paths=(java.util.List)value;return;
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid").set("class",askSchema().askOriginalType().getName());
        }
        }catch(NullPointerException e){
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             case 1: this._paths=(java.util.List)value;return true;
            default:return false;
        }
    }
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 1:
            ...
            this._paths=(java.util.List)converter.read(session);
...
if(this._paths!=null && (0 & transience)==0){
    out.writeByte(1);
        
    converter.write(this._paths,session);
