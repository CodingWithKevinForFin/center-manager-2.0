...
public  class AmiWebManagerGetFileRequest000 extends com.f1.ami.amicommon.msg.AmiWebManagerGetFileRequest00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public void setAsOfModifiedTime(long _asOfModifiedTime){
	    super.setAsOfModifiedTime(_asOfModifiedTime);
	    existing.set(0,true);
    }
    public boolean askExistsAsOfModifiedTime(){
    ...
    public void setParentFileName(java.lang.String _parentFileName){
	    super.setParentFileName(_parentFileName);
	    existing.set(5,true);
    }
    public boolean askExistsParentFileName(){
	...
	public AmiWebManagerGetFileRequest000 nw(){
	    return new AmiWebManagerGetFileRequest000();
	}

	public AmiWebManagerGetFileRequest000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiWebManagerGetFileRequest000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getParentFileName(),session);
    ...
    out.writeByte(6);
    out.writeLong(this.getAsOfModifiedTime());
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 2:
                    ...
                    this.setParentFileName((java.lang.String)converter.read(session));
                ...
                case 5:
                    ...
                    if((basicType=in.readByte())!=6)
                        break;
                    this.setAsOfModifiedTime(in.readLong());
