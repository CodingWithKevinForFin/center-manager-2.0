...
public  class AmiWebManagerListRootsResponse000 extends com.f1.ami.amicommon.msg.AmiWebManagerListRootsResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public void setFiles(java.util.List _files){
	    super.setFiles(_files);
	    existing.set(1,true);
    }
    public boolean askExistsFiles(){
	...
	public AmiWebManagerListRootsResponse000 nw(){
	    return new AmiWebManagerListRootsResponse000();
	}

	public AmiWebManagerListRootsResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiWebManagerListRootsResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getFiles(),session);
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 1:
                    ...
                    this.setFiles((java.util.List)converter.read(session));
