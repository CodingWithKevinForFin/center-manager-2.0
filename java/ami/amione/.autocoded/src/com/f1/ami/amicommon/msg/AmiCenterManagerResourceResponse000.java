...
public  class AmiCenterManagerResourceResponse000 extends com.f1.ami.amicommon.msg.AmiCenterManagerResourceResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public void setResources(java.util.List _resources){
	    super.setResources(_resources);
	    existing.set(5,true);
    }
    public boolean askExistsResources(){
	...
	public AmiCenterManagerResourceResponse000 nw(){
	    return new AmiCenterManagerResourceResponse000();
	}

	public AmiCenterManagerResourceResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterManagerResourceResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getResources(),session);
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 1:
                    ...
                    this.setResources((java.util.List)converter.read(session));
