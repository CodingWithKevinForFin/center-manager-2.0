...
public  class AmiCenterResponse000 extends com.f1.ami.amicommon.msg.AmiCenterResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiCenterResponse000 nw(){
	    return new AmiCenterResponse000();
	}

	public AmiCenterResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
