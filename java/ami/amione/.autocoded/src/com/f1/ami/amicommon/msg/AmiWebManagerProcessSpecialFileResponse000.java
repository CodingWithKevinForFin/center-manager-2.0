...
public  class AmiWebManagerProcessSpecialFileResponse000 extends com.f1.ami.amicommon.msg.AmiWebManagerProcessSpecialFileResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public void setResults(com.f1.base.Table _results){
	    super.setResults(_results);
	    existing.set(5,true);
    }
    public boolean askExistsResults(){
	...
	public AmiWebManagerProcessSpecialFileResponse000 nw(){
	    return new AmiWebManagerProcessSpecialFileResponse000();
	}

	public AmiWebManagerProcessSpecialFileResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiWebManagerProcessSpecialFileResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getResults(),session);
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 1:
                    ...
                    this.setResults((com.f1.base.Table)converter.read(session));
