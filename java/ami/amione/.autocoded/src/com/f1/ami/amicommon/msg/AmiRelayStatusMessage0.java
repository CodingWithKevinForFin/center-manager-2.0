...
public abstract class AmiRelayStatusMessage0 implements com.f1.ami.amicommon.msg.AmiRelayStatusMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "appIdStringKey" ,"connectionId","message","origSeqNum","params","status","transformState"};
    ...
    public void put(String name, Object value){//asdf
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "status" || name.equals("status")) {this._status=(java.lang.Integer)value;return;}
break;
                case 2:
    ...
    public boolean putNoThrow(String name, Object value){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "status" || name.equals("status")) {this._status=(java.lang.Integer)value;return true;}
break;
                case 2:
    ...
    public Class askClass(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "status" || name.equals("status")) {return int.class;}
break;
                case 2:
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "status" || name.equals("status")) {return 5;}
break;
                case 2:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiRelayStatusMessage0.class;
	}
    ...
    public byte askBasicType(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "status" || name.equals("status")) {return 4;}
break;
                case 2:
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_appIdStringKey extends AbstractValuedParam<AmiRelayStatusMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiRelayStatusMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiRelayStatusMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiRelayStatusMessage0 valued) {
		    return (short)((AmiRelayStatusMessage0)valued).getAppIdStringKey();
	    }
    
	    @Override
	    public void setValue(AmiRelayStatusMessage0 valued, Object value) {
		    valued.setAppIdStringKey((java.lang.Short)value);
	    }
    
	    @Override
	    public void copy(AmiRelayStatusMessage0 source, AmiRelayStatusMessage0 dest) {
		    dest.setAppIdStringKey(source.getAppIdStringKey());
	    }
	    
	    @Override
	    public boolean areEqual(AmiRelayStatusMessage0 source, AmiRelayStatusMessage0 dest) {
	    ...
	    @Override
	    public short getShort(AmiRelayStatusMessage0 valued) {
		    return valued.getAppIdStringKey();
	    }
    
	    @Override
	    public void setShort(AmiRelayStatusMessage0 valued, short value) {
	    ...
	    @Override
	    public void append(AmiRelayStatusMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getAppIdStringKey());
	        
	    }
	    @Override
	    public void append(AmiRelayStatusMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiRelayStatusMessage0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_connectionId extends AbstractValuedParam<AmiRelayStatusMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayStatusMessage0 valued) {
		    return (int)((AmiRelayStatusMessage0)valued).getConnectionId();
	    }
	    ...
	    @Override
	    public int getInt(AmiRelayStatusMessage0 valued) {
		    return valued.getConnectionId();
	    }
    
	    @Override
	    public void setInt(AmiRelayStatusMessage0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiRelayStatusMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayStatusMessage0 valued) {
		    return (java.lang.String)((AmiRelayStatusMessage0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_origSeqNum extends AbstractValuedParam<AmiRelayStatusMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayStatusMessage0 valued) {
		    return (long)((AmiRelayStatusMessage0)valued).getOrigSeqNum();
	    }
	    ...
	    @Override
	    public long getLong(AmiRelayStatusMessage0 valued) {
		    return valued.getOrigSeqNum();
	    }
    
	    @Override
	    public void setLong(AmiRelayStatusMessage0 valued, long value) {
    ...
    private static final class VALUED_PARAM_CLASS_params extends AbstractValuedParam<AmiRelayStatusMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayStatusMessage0 valued) {
		    return (byte[])((AmiRelayStatusMessage0)valued).getParams();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_status extends AbstractValuedParam<AmiRelayStatusMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    public void write(AmiRelayStatusMessage0 valued, DataOutput stream) throws IOException{
		      ...
		      stream.writeInt(valued.getStatus());
	    ...
	    public void read(AmiRelayStatusMessage0 valued, DataInput stream) throws IOException{
		      ...
		      valued.setStatus(stream.readInt());
	    ...
	    @Override
	    public Object getValue(AmiRelayStatusMessage0 valued) {
		    return (int)((AmiRelayStatusMessage0)valued).getStatus();
	    }
    
	    @Override
	    public void setValue(AmiRelayStatusMessage0 valued, Object value) {
		    valued.setStatus((java.lang.Integer)value);
	    }
    ...
    private static final class VALUED_PARAM_CLASS_transformState extends AbstractValuedParam<AmiRelayStatusMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayStatusMessage0 valued) {
		    return (byte)((AmiRelayStatusMessage0)valued).getTransformState();
	    }
	    ...
	    @Override
	    public byte getByte(AmiRelayStatusMessage0 valued) {
		    return valued.getTransformState();
	    }
    
	    @Override
	    public void setByte(AmiRelayStatusMessage0 valued, byte value) {
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_appIdStringKey, VALUED_PARAM_connectionId, VALUED_PARAM_message, VALUED_PARAM_origSeqNum, VALUED_PARAM_params, VALUED_PARAM_status, VALUED_PARAM_transformState, };



    private static final byte PIDS[]={ 44 ,10,5,45,4,7,46};
    ...
    public void put(byte pid,Object value){
        ...
        switch(pid){
             ...
             case 5: this._message=(java.lang.String)value;return;
             case 45: this._origSeqNum=(java.lang.Long)value;return;
             case 4: this._params=(byte[])value;return;
             case 7: this._status=(java.lang.Integer)value;return;
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             ...
             case 5: this._message=(java.lang.String)value;return true;
             case 45: this._origSeqNum=(java.lang.Long)value;return true;
             case 4: this._params=(byte[])value;return true;
             case 7: this._status=(java.lang.Integer)value;return true;
    ...
    public void putInt(byte pid,int value){
        ...
        switch(pid){
             ...
             case 7: this._status=value;return;
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid for int value").set("class",askSchema().askOriginalType().getName());
        }
    }
...
if(this._status!=0 && (0 & transience)==0){
    out.writeByte(7);
