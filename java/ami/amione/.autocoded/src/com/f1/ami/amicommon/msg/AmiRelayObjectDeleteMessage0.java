...
public abstract class AmiRelayObjectDeleteMessage0 implements com.f1.ami.amicommon.msg.AmiRelayObjectDeleteMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "appIdStringKey" ,"connectionId","id","origSeqNum","params","transformState","type"};
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "type" || name.equals("type")) {return 6;}
break;
                case 2:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiRelayObjectDeleteMessage0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_appIdStringKey extends AbstractValuedParam<AmiRelayObjectDeleteMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiRelayObjectDeleteMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiRelayObjectDeleteMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiRelayObjectDeleteMessage0 valued) {
		    return (short)((AmiRelayObjectDeleteMessage0)valued).getAppIdStringKey();
	    }
    
	    @Override
	    public void setValue(AmiRelayObjectDeleteMessage0 valued, Object value) {
		    valued.setAppIdStringKey((java.lang.Short)value);
	    }
    
	    @Override
	    public void copy(AmiRelayObjectDeleteMessage0 source, AmiRelayObjectDeleteMessage0 dest) {
		    dest.setAppIdStringKey(source.getAppIdStringKey());
	    }
	    
	    @Override
	    public boolean areEqual(AmiRelayObjectDeleteMessage0 source, AmiRelayObjectDeleteMessage0 dest) {
	    ...
	    @Override
	    public short getShort(AmiRelayObjectDeleteMessage0 valued) {
		    return valued.getAppIdStringKey();
	    }
    
	    @Override
	    public void setShort(AmiRelayObjectDeleteMessage0 valued, short value) {
	    ...
	    @Override
	    public void append(AmiRelayObjectDeleteMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getAppIdStringKey());
	        
	    }
	    @Override
	    public void append(AmiRelayObjectDeleteMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiRelayObjectDeleteMessage0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_connectionId extends AbstractValuedParam<AmiRelayObjectDeleteMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayObjectDeleteMessage0 valued) {
		    return (int)((AmiRelayObjectDeleteMessage0)valued).getConnectionId();
	    }
	    ...
	    @Override
	    public int getInt(AmiRelayObjectDeleteMessage0 valued) {
		    return valued.getConnectionId();
	    }
    
	    @Override
	    public void setInt(AmiRelayObjectDeleteMessage0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_id extends AbstractValuedParam<AmiRelayObjectDeleteMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayObjectDeleteMessage0 valued) {
		    return (java.lang.String)((AmiRelayObjectDeleteMessage0)valued).getId();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_origSeqNum extends AbstractValuedParam<AmiRelayObjectDeleteMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayObjectDeleteMessage0 valued) {
		    return (long)((AmiRelayObjectDeleteMessage0)valued).getOrigSeqNum();
	    }
	    ...
	    @Override
	    public long getLong(AmiRelayObjectDeleteMessage0 valued) {
		    return valued.getOrigSeqNum();
	    }
    
	    @Override
	    public void setLong(AmiRelayObjectDeleteMessage0 valued, long value) {
    ...
    private static final class VALUED_PARAM_CLASS_params extends AbstractValuedParam<AmiRelayObjectDeleteMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayObjectDeleteMessage0 valued) {
		    return (byte[])((AmiRelayObjectDeleteMessage0)valued).getParams();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_transformState extends AbstractValuedParam<AmiRelayObjectDeleteMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayObjectDeleteMessage0 valued) {
		    return (byte)((AmiRelayObjectDeleteMessage0)valued).getTransformState();
	    }
	    ...
	    @Override
	    public byte getByte(AmiRelayObjectDeleteMessage0 valued) {
		    return valued.getTransformState();
	    }
    
	    @Override
	    public void setByte(AmiRelayObjectDeleteMessage0 valued, byte value) {
    ...
    private static final class VALUED_PARAM_CLASS_type extends AbstractValuedParam<AmiRelayObjectDeleteMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayObjectDeleteMessage0 valued) {
		    return (java.lang.String)((AmiRelayObjectDeleteMessage0)valued).getType();
	    }
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_appIdStringKey, VALUED_PARAM_connectionId, VALUED_PARAM_id, VALUED_PARAM_origSeqNum, VALUED_PARAM_params, VALUED_PARAM_transformState, VALUED_PARAM_type, };



    private static final byte PIDS[]={ 44 ,10,3,45,4,46,2};
