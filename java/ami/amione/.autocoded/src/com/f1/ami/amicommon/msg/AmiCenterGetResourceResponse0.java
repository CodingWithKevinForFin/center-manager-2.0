...
public abstract class AmiCenterGetResourceResponse0 implements com.f1.ami.amicommon.msg.AmiCenterGetResourceResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "resources" };
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "resources" || name.equals("resources")) {return 0;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterGetResourceResponse0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_resources extends AbstractValuedParam<AmiCenterGetResourceResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterGetResourceResponse0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterGetResourceResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterGetResourceResponse0 valued) {
		    return (java.util.List)((AmiCenterGetResourceResponse0)valued).getResources();
	    }
    
	    @Override
	    public void setValue(AmiCenterGetResourceResponse0 valued, Object value) {
		    valued.setResources((java.util.List)value);
	    }
    
	    @Override
	    public void copy(AmiCenterGetResourceResponse0 source, AmiCenterGetResourceResponse0 dest) {
		    dest.setResources(source.getResources());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterGetResourceResponse0 source, AmiCenterGetResourceResponse0 dest) {
	    ...
	    @Override
	    public void append(AmiCenterGetResourceResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getResources());
	        
	    }
	    @Override
	    public void append(AmiCenterGetResourceResponse0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiCenterGetResourceResponse0 valued){
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_resources, };
