...
public  class AmiResponse000 extends com.f1.ami.amicommon.msg.AmiResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiResponse000 nw(){
	    return new AmiResponse000();
	}

	public AmiResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
