...
public  class AmiCenterRequest000 extends com.f1.ami.amicommon.msg.AmiCenterRequest00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiCenterRequest000 nw(){
	    return new AmiCenterRequest000();
	}

	public AmiCenterRequest000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterRequest000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
