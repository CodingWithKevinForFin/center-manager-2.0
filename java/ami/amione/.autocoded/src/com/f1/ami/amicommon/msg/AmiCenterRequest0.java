...
public abstract class AmiCenterRequest0 implements com.f1.ami.amicommon.msg.AmiCenterRequest ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterRequest0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_comment extends AbstractValuedParam<AmiCenterRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterRequest0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterRequest0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterRequest0 valued) {
		    return (java.lang.String)((AmiCenterRequest0)valued).getComment();
	    }
    
	    @Override
	    public void setValue(AmiCenterRequest0 valued, Object value) {
		    valued.setComment((java.lang.String)value);
	    }
    
	    @Override
	    public void copy(AmiCenterRequest0 source, AmiCenterRequest0 dest) {
		    dest.setComment(source.getComment());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterRequest0 source, AmiCenterRequest0 dest) {
	    ...
	    @Override
	    public void append(AmiCenterRequest0 valued, StringBuilder sb){
	        
	           SH.quote('"',valued.getComment(),sb);
	        
	    }
	    @Override
	    public void append(AmiCenterRequest0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiCenterRequest0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_invokedBy extends AbstractValuedParam<AmiCenterRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterRequest0 valued) {
		    return (java.lang.String)((AmiCenterRequest0)valued).getInvokedBy();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiCenterRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterRequest0 valued) {
		    return (int)((AmiCenterRequest0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiCenterRequest0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiCenterRequest0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_requestTime extends AbstractValuedParam<AmiCenterRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterRequest0 valued) {
		    return (long)((AmiCenterRequest0)valued).getRequestTime();
	    }
	    ...
	    @Override
	    public long getLong(AmiCenterRequest0 valued) {
		    return valued.getRequestTime();
	    }
    
	    @Override
	    public void setLong(AmiCenterRequest0 valued, long value) {
