...
public abstract class AmiResponse0 implements com.f1.ami.amicommon.msg.AmiResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiResponse0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_exception extends AbstractValuedParam<AmiResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiResponse0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiResponse0 valued) {
		    return (java.lang.Exception)((AmiResponse0)valued).getException();
	    }
    
	    @Override
	    public void setValue(AmiResponse0 valued, Object value) {
		    valued.setException((java.lang.Exception)value);
	    }
    
	    @Override
	    public void copy(AmiResponse0 source, AmiResponse0 dest) {
		    dest.setException(source.getException());
	    }
	    
	    @Override
	    public boolean areEqual(AmiResponse0 source, AmiResponse0 dest) {
	    ...
	    @Override
	    public void append(AmiResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getException());
	        
	    }
	    @Override
	    public void append(AmiResponse0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiResponse0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiResponse0 valued) {
		    return (java.lang.String)((AmiResponse0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_ok extends AbstractValuedParam<AmiResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiResponse0 valued) {
		    return (boolean)((AmiResponse0)valued).getOk();
	    }
	    ...
	    @Override
	    public boolean getBoolean(AmiResponse0 valued) {
		    return valued.getOk();
	    }
    
	    @Override
	    public void setBoolean(AmiResponse0 valued, boolean value) {
		    valued.setOk(value);
	    }
