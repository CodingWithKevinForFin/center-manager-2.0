...
public  class AmiWebManagerProcessSpecialFileRequest000 extends com.f1.ami.amicommon.msg.AmiWebManagerProcessSpecialFileRequest00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public void setInstruction(java.lang.String _instruction){
	    super.setInstruction(_instruction);
	    existing.set(2,true);
    }
    public boolean askExistsInstruction(){
	...
	public AmiWebManagerProcessSpecialFileRequest000 nw(){
	    return new AmiWebManagerProcessSpecialFileRequest000();
	}

	public AmiWebManagerProcessSpecialFileRequest000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiWebManagerProcessSpecialFileRequest000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getInstruction(),session);
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 2:
                    ...
                    this.setOptions((java.util.Map)converter.read(session));
        
                    continue;
  
                case 3:
        
                    this.setInstruction((java.lang.String)converter.read(session));
