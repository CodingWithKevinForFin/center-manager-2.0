...
public abstract class AmiCenterManageAmiDataResponse0 implements com.f1.ami.amicommon.msg.AmiCenterManageAmiDataResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "exception" ,"message","ok","priority","progress","ticket","trackedEvents"};
...
break;
                case 5:
                    ...
                    if(name == "trackedEvents" || name.equals("trackedEvents")) {return 6;}
break;
                case 7:
...
break;
                case 14:
                    ...
                    if(name == "ticket" || name.equals("ticket")) {return 5;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterManageAmiDataResponse0.class;
	}
...
break;
    ...
    public Object askAtPosition(int position){
        ...
        case 5:return _ticket;

        case 6:return _trackedEvents;
    ...
    private static final class VALUED_PARAM_CLASS_exception extends AbstractValuedParam<AmiCenterManageAmiDataResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterManageAmiDataResponse0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterManageAmiDataResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataResponse0 valued) {
		    return (java.lang.Exception)((AmiCenterManageAmiDataResponse0)valued).getException();
	    }
    
	    @Override
	    public void setValue(AmiCenterManageAmiDataResponse0 valued, Object value) {
		    valued.setException((java.lang.Exception)value);
	    }
    
	    @Override
	    public void copy(AmiCenterManageAmiDataResponse0 source, AmiCenterManageAmiDataResponse0 dest) {
		    dest.setException(source.getException());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterManageAmiDataResponse0 source, AmiCenterManageAmiDataResponse0 dest) {
	    ...
	    @Override
	    public void append(AmiCenterManageAmiDataResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getException());
	        
	    }
	    @Override
	    public void append(AmiCenterManageAmiDataResponse0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiCenterManageAmiDataResponse0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiCenterManageAmiDataResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataResponse0 valued) {
		    return (java.lang.String)((AmiCenterManageAmiDataResponse0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_ok extends AbstractValuedParam<AmiCenterManageAmiDataResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataResponse0 valued) {
		    return (boolean)((AmiCenterManageAmiDataResponse0)valued).getOk();
	    }
	    ...
	    @Override
	    public boolean getBoolean(AmiCenterManageAmiDataResponse0 valued) {
		    return valued.getOk();
	    }
    
	    @Override
	    public void setBoolean(AmiCenterManageAmiDataResponse0 valued, boolean value) {
		    valued.setOk(value);
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiCenterManageAmiDataResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataResponse0 valued) {
		    return (int)((AmiCenterManageAmiDataResponse0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiCenterManageAmiDataResponse0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiCenterManageAmiDataResponse0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_progress extends AbstractValuedParam<AmiCenterManageAmiDataResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataResponse0 valued) {
		    return (double)((AmiCenterManageAmiDataResponse0)valued).getProgress();
	    }
	    ...
	    @Override
	    public double getDouble(AmiCenterManageAmiDataResponse0 valued) {
		    return valued.getProgress();
	    }
    
	    @Override
	    public void setDouble(AmiCenterManageAmiDataResponse0 valued, double value) {
    ...
    private static final class VALUED_PARAM_CLASS_ticket extends AbstractValuedParam<AmiCenterManageAmiDataResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataResponse0 valued) {
		    return (java.lang.String)((AmiCenterManageAmiDataResponse0)valued).getTicket();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_trackedEvents extends AbstractValuedParam<AmiCenterManageAmiDataResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataResponse0 valued) {
		    return (java.util.List)((AmiCenterManageAmiDataResponse0)valued).getTrackedEvents();
	    }
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_exception, VALUED_PARAM_message, VALUED_PARAM_ok, VALUED_PARAM_priority, VALUED_PARAM_progress, VALUED_PARAM_ticket, VALUED_PARAM_trackedEvents, };



    private static final byte PIDS[]={ 44 ,43,42,57,53,55,58};
