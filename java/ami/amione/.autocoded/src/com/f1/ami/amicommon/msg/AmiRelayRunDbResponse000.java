...
public  class AmiRelayRunDbResponse000 extends com.f1.ami.amicommon.msg.AmiRelayRunDbResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public void setClientResponse(com.f1.ami.amicommon.msg.AmiCenterResponse _clientResponse){
	    super.setClientResponse(_clientResponse);
	    existing.set(0,true);
    }
    public boolean askExistsClientResponse(){
	...
	public AmiRelayRunDbResponse000 nw(){
	    return new AmiRelayRunDbResponse000();
	}

	public AmiRelayRunDbResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiRelayRunDbResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getClientResponse(),session);
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 2:
                    ...
                    this.setClientResponse((com.f1.ami.amicommon.msg.AmiCenterResponse)converter.read(session));
