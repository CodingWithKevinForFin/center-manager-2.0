...
public  class AmiCenterQueryDsTrackerEvent000 extends com.f1.ami.amicommon.msg.AmiCenterQueryDsTrackerEvent00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public boolean askExistsDuration(){
    ...
    public void setResultTableName(java.lang.String _resultTableName){
	    super.setResultTableName(_resultTableName);
	    existing.set(6,true);
    }
    public boolean askExistsResultTableName(){
	    return existing.get(6);
    }

	@Override
    public void setResultTableSample(com.f1.base.Table _resultTableSample){
	    super.setResultTableSample(_resultTableSample);
	    existing.set(7,true);
    }
    public boolean askExistsResultTableSample(){
	    return existing.get(7);
    }

	@Override
    public void setResultTableSize(int _resultTableSize){
	    super.setResultTableSize(_resultTableSize);
	    existing.set(8,true);
    }
    public boolean askExistsResultTableSize(){
    ...
    public boolean askExistsString(){
    ...
    public void setTimestamp(long _timestamp){
	    super.setTimestamp(_timestamp);
	    existing.set(11,true);
    }
    public boolean askExistsTimestamp(){
	...
	public AmiCenterQueryDsTrackerEvent000 nw(){
	    return new AmiCenterQueryDsTrackerEvent000();
	}

	public AmiCenterQueryDsTrackerEvent000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterQueryDsTrackerEvent000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getString(),session);
    ...
    out.writeByte(6);
    out.writeLong(this.getDuration());
    ...
    out.writeByte(4);
    out.writeInt(this.getResultTableSize());
    ...
    converter.write(this.getResultTableSample(),session);
    ...
    converter.write(this.getResultTableName(),session);
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 4:
                    ...
                    this.setString((java.lang.String)converter.read(session));
                ...
                case 8:
                    ...
                    if((basicType=in.readByte())!=4)
                        break;
                    this.setResultTableSize(in.readInt());
        
                    continue;
  
                case 9:
        
                    this.setResultTableSample((com.f1.base.Table)converter.read(session));
        
                    continue;
  
                case 10:
        
                    this.setResultTableName((java.lang.String)converter.read(session));
