...
public  class AmiRelayRequest000 extends com.f1.ami.amicommon.msg.AmiRelayRequest00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiRelayRequest000 nw(){
	    return new AmiRelayRequest000();
	}

	public AmiRelayRequest000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiRelayRequest000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
