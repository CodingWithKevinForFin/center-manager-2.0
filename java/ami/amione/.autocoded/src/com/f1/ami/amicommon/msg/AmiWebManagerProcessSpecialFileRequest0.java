...
public abstract class AmiWebManagerProcessSpecialFileRequest0 implements com.f1.ami.amicommon.msg.AmiWebManagerProcessSpecialFileRequest ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "comment" ,"fileName","instruction","invokedBy","options","priority","requestTime"};
...
break;
                case 6:
                    ...
                    if(name == "options" || name.equals("options")) {this._options=(java.util.Map)value;return;}
break;
                case 8:
...
break;
                case 10:
                    ...
                    if(name == "instruction" || name.equals("instruction")) {this._instruction=(java.lang.String)value;return;}
break;
                case 11:
...
break;
                case 6:
                    ...
                    if(name == "options" || name.equals("options")) {this._options=(java.util.Map)value;return true;}
break;
                case 8:
...
break;
                case 10:
                    ...
                    if(name == "instruction" || name.equals("instruction")) {this._instruction=(java.lang.String)value;return true;}
break;
                case 11:
...
break;
                case 10:
                    ...
                    if(name == "instruction" || name.equals("instruction")) {return this._instruction;}
...
break;
                case 6:
                    ...
                    if(name == "options" || name.equals("options")) {return java.util.Map.class;}
break;
                case 8:
...
break;
                case 10:
                    ...
                    if(name == "instruction" || name.equals("instruction")) {return java.lang.String.class;}
break;
                case 11:
...
break;
                case 10:
                    ...
                    if(name == "instruction" || name.equals("instruction")) {return VALUED_PARAM_instruction;}
break;
                case 11:
...
break;
                case 1:
                    ...
                    if(name == "fileName" || name.equals("fileName")) {return 1;}
break;
                case 5:
...
break;
                case 10:
                    ...
                    if(name == "instruction" || name.equals("instruction")) {return 2;}
break;
                case 11:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiWebManagerProcessSpecialFileRequest0.class;
	}
...
break;
                case 10:
                    ...
                    if(name == "instruction" || name.equals("instruction")) {return true;}
break;
                case 11:
...
break;
                case 6:
                    ...
                    if(name == "options" || name.equals("options")) {return 23;}
break;
                case 8:
...
break;
                case 10:
                    ...
                    if(name == "instruction" || name.equals("instruction")) {return 20;}
break;
                case 11:
...
break;
    ...
    public Object askAtPosition(int position){
        ...
        case 1:return _fileName;

        case 2:return _instruction;
    ...
    public void setInstruction(java.lang.String _instruction){
    ...
    public void setOptions(java.util.Map _options){
    ...
    private static final class VALUED_PARAM_CLASS_comment extends AbstractValuedParam<AmiWebManagerProcessSpecialFileRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiWebManagerProcessSpecialFileRequest0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiWebManagerProcessSpecialFileRequest0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileRequest0 valued) {
		    return (java.lang.String)((AmiWebManagerProcessSpecialFileRequest0)valued).getComment();
	    }
    
	    @Override
	    public void setValue(AmiWebManagerProcessSpecialFileRequest0 valued, Object value) {
		    valued.setComment((java.lang.String)value);
	    }
    
	    @Override
	    public void copy(AmiWebManagerProcessSpecialFileRequest0 source, AmiWebManagerProcessSpecialFileRequest0 dest) {
		    dest.setComment(source.getComment());
	    }
	    
	    @Override
	    public boolean areEqual(AmiWebManagerProcessSpecialFileRequest0 source, AmiWebManagerProcessSpecialFileRequest0 dest) {
	    ...
	    @Override
	    public void append(AmiWebManagerProcessSpecialFileRequest0 valued, StringBuilder sb){
	        
	           SH.quote('"',valued.getComment(),sb);
	        
	    }
	    @Override
	    public void append(AmiWebManagerProcessSpecialFileRequest0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiWebManagerProcessSpecialFileRequest0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_fileName extends AbstractValuedParam<AmiWebManagerProcessSpecialFileRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileRequest0 valued) {
		    return (java.lang.String)((AmiWebManagerProcessSpecialFileRequest0)valued).getFileName();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_instruction extends AbstractValuedParam<AmiWebManagerProcessSpecialFileRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileRequest0 valued) {
		    return (java.lang.String)((AmiWebManagerProcessSpecialFileRequest0)valued).getInstruction();
	    }
    
	    @Override
	    public void setValue(AmiWebManagerProcessSpecialFileRequest0 valued, Object value) {
		    valued.setInstruction((java.lang.String)value);
	    }
	    ...
	    @Override
	    public boolean areEqual(AmiWebManagerProcessSpecialFileRequest0 source, AmiWebManagerProcessSpecialFileRequest0 dest) {
	        return OH.eq(dest.getInstruction(),source.getInstruction());
	    }
	    ...
	    public void append(AmiWebManagerProcessSpecialFileRequest0 valued, StringBuilder sb){
	           ...
	           SH.quote('"',valued.getInstruction(),sb);
	    ...
	    @Override
	    public String toString(){
	        return "ValuedParam:java.lang.String instruction";
	    }
	    @Override
	    public void clear(AmiWebManagerProcessSpecialFileRequest0 valued){
	       valued.setInstruction(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_instruction=new VALUED_PARAM_CLASS_instruction();
  

  
    private static final class VALUED_PARAM_CLASS_invokedBy extends AbstractValuedParam<AmiWebManagerProcessSpecialFileRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileRequest0 valued) {
		    return (java.lang.String)((AmiWebManagerProcessSpecialFileRequest0)valued).getInvokedBy();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_options extends AbstractValuedParam<AmiWebManagerProcessSpecialFileRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileRequest0 valued) {
		    return (java.util.Map)((AmiWebManagerProcessSpecialFileRequest0)valued).getOptions();
	    }
    
	    @Override
	    public void setValue(AmiWebManagerProcessSpecialFileRequest0 valued, Object value) {
		    valued.setOptions((java.util.Map)value);
	    }
	    ...
	    @Override
	    public String toString(){
	        return "ValuedParam:java.util.Map options";
	    }
	    @Override
	    public void clear(AmiWebManagerProcessSpecialFileRequest0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiWebManagerProcessSpecialFileRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileRequest0 valued) {
		    return (int)((AmiWebManagerProcessSpecialFileRequest0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiWebManagerProcessSpecialFileRequest0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiWebManagerProcessSpecialFileRequest0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_requestTime extends AbstractValuedParam<AmiWebManagerProcessSpecialFileRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileRequest0 valued) {
		    return (long)((AmiWebManagerProcessSpecialFileRequest0)valued).getRequestTime();
	    }
	    ...
	    @Override
	    public long getLong(AmiWebManagerProcessSpecialFileRequest0 valued) {
		    return valued.getRequestTime();
	    }
    
	    @Override
	    public void setLong(AmiWebManagerProcessSpecialFileRequest0 valued, long value) {
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_comment, VALUED_PARAM_fileName, VALUED_PARAM_instruction, VALUED_PARAM_invokedBy, VALUED_PARAM_options, VALUED_PARAM_priority, VALUED_PARAM_requestTime, };



    private static final byte PIDS[]={ 52 ,1,3,51,2,53,54};
    ...
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             ...
             case 3: return VALUED_PARAM_instruction;
             case 51: return VALUED_PARAM_invokedBy;
             case 2: return VALUED_PARAM_options;
    ...
    public Object ask(byte pid){
        switch(pid){
             ...
             case 3: return  this._instruction; 
             case 51: return  this._invokedBy; 
             case 2: return  this._options; 
    ...
    public Class askClass(byte pid){
        switch(pid){
             ...
             case 2: return java.util.Map.class;
    ...
    public void put(byte pid,Object value){
        ...
        switch(pid){
             ...
             case 3: this._instruction=(java.lang.String)value;return;
             case 51: this._invokedBy=(java.lang.String)value;return;
             case 2: this._options=(java.util.Map)value;return;
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             ...
             case 3: this._instruction=(java.lang.String)value;return true;
             case 51: this._invokedBy=(java.lang.String)value;return true;
             case 2: this._options=(java.util.Map)value;return true;
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 2:
            ...
            this._options=(java.util.Map)converter.read(session);
        
            break;

        case 3:
        
            this._instruction=(java.lang.String)converter.read(session);
...
if(this._instruction!=null && (0 & transience)==0){
    out.writeByte(3);
        
    converter.write(this._instruction,session);
