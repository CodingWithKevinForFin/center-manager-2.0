...
public  class AmiCenterManageAmiDataResponse000 extends com.f1.ami.amicommon.msg.AmiCenterManageAmiDataResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiCenterManageAmiDataResponse000 nw(){
	    return new AmiCenterManageAmiDataResponse000();
	}

	public AmiCenterManageAmiDataResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterManageAmiDataResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
