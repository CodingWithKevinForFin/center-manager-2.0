...
public  class AmiCenterGetSnapshotResponse000 extends com.f1.ami.amicommon.msg.AmiCenterGetSnapshotResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiCenterGetSnapshotResponse000 nw(){
	    return new AmiCenterGetSnapshotResponse000();
	}

	public AmiCenterGetSnapshotResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterGetSnapshotResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 1:
                    ...
                    this.setSnapshot((com.f1.ami.amicommon.msg.AmiCenterChanges)converter.read(session));
