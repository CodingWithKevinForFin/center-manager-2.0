...
public abstract class AmiRelayErrorMessage0 implements com.f1.ami.amicommon.msg.AmiRelayErrorMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "appIdStringKey" ,"connectionId","origSeqNum","params","transformState"};
...
break;
                case 2:
                    ...
                    if(name == "origSeqNum" || name.equals("origSeqNum")) {return 2;}
break;
                case 4:

                    if(name == "params" || name.equals("params")) {return 3;}
break;
                case 5:

                    if(name == "transformState" || name.equals("transformState")) {return 4;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
	...
	public Class<Valued> askType(){
	    return (Class)AmiRelayErrorMessage0.class;
	}
...
break;
    ...
    public Object askAtPosition(int position){
        ...
        case 2:return _origSeqNum;

        case 3:return _params;

        case 4:return _transformState;
    ...
    private static final class VALUED_PARAM_CLASS_appIdStringKey extends AbstractValuedParam<AmiRelayErrorMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiRelayErrorMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiRelayErrorMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiRelayErrorMessage0 valued) {
		    return (short)((AmiRelayErrorMessage0)valued).getAppIdStringKey();
	    }
    
	    @Override
	    public void setValue(AmiRelayErrorMessage0 valued, Object value) {
		    valued.setAppIdStringKey((java.lang.Short)value);
	    }
    
	    @Override
	    public void copy(AmiRelayErrorMessage0 source, AmiRelayErrorMessage0 dest) {
		    dest.setAppIdStringKey(source.getAppIdStringKey());
	    }
	    
	    @Override
	    public boolean areEqual(AmiRelayErrorMessage0 source, AmiRelayErrorMessage0 dest) {
	    ...
	    @Override
	    public short getShort(AmiRelayErrorMessage0 valued) {
		    return valued.getAppIdStringKey();
	    }
    
	    @Override
	    public void setShort(AmiRelayErrorMessage0 valued, short value) {
	    ...
	    @Override
	    public void append(AmiRelayErrorMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getAppIdStringKey());
	        
	    }
	    @Override
	    public void append(AmiRelayErrorMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiRelayErrorMessage0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_connectionId extends AbstractValuedParam<AmiRelayErrorMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayErrorMessage0 valued) {
		    return (int)((AmiRelayErrorMessage0)valued).getConnectionId();
	    }
	    ...
	    @Override
	    public int getInt(AmiRelayErrorMessage0 valued) {
		    return valued.getConnectionId();
	    }
    
	    @Override
	    public void setInt(AmiRelayErrorMessage0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_origSeqNum extends AbstractValuedParam<AmiRelayErrorMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayErrorMessage0 valued) {
		    return (long)((AmiRelayErrorMessage0)valued).getOrigSeqNum();
	    }
	    ...
	    @Override
	    public long getLong(AmiRelayErrorMessage0 valued) {
		    return valued.getOrigSeqNum();
	    }
    
	    @Override
	    public void setLong(AmiRelayErrorMessage0 valued, long value) {
    ...
    private static final class VALUED_PARAM_CLASS_params extends AbstractValuedParam<AmiRelayErrorMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayErrorMessage0 valued) {
		    return (byte[])((AmiRelayErrorMessage0)valued).getParams();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_transformState extends AbstractValuedParam<AmiRelayErrorMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayErrorMessage0 valued) {
		    return (byte)((AmiRelayErrorMessage0)valued).getTransformState();
	    }
	    ...
	    @Override
	    public byte getByte(AmiRelayErrorMessage0 valued) {
		    return valued.getTransformState();
	    }
    
	    @Override
	    public void setByte(AmiRelayErrorMessage0 valued, byte value) {
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_appIdStringKey, VALUED_PARAM_connectionId, VALUED_PARAM_origSeqNum, VALUED_PARAM_params, VALUED_PARAM_transformState, };



    private static final byte PIDS[]={ 44 ,10,45,4,46};
