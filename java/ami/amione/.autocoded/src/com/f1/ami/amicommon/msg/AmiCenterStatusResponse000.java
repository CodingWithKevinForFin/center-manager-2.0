...
public  class AmiCenterStatusResponse000 extends com.f1.ami.amicommon.msg.AmiCenterStatusResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiCenterStatusResponse000 nw(){
	    return new AmiCenterStatusResponse000();
	}

	public AmiCenterStatusResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterStatusResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
