...
public abstract class AmiRelayRunDbResponse0 implements com.f1.ami.amicommon.msg.AmiRelayRunDbResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private com.f1.ami.amicommon.msg.AmiCenterResponse _clientResponse;
    ...
    private static final String NAMES[]={ "clientResponse" ,"exception","message","ok"};
...
break;
                case 5:
                    ...
                    if(name == "clientResponse" || name.equals("clientResponse")) {this._clientResponse=(com.f1.ami.amicommon.msg.AmiCenterResponse)value;return;}
break;
                case 7:
...
break;
                case 5:
                    ...
                    if(name == "clientResponse" || name.equals("clientResponse")) {this._clientResponse=(com.f1.ami.amicommon.msg.AmiCenterResponse)value;return true;}
break;
                case 7:
...
break;
                case 5:
                    ...
                    if(name == "clientResponse" || name.equals("clientResponse")) {return this._clientResponse;}
...
break;
                case 5:
                    ...
                    if(name == "clientResponse" || name.equals("clientResponse")) {return com.f1.ami.amicommon.msg.AmiCenterResponse.class;}
break;
                case 7:
...
break;
                case 5:
                    ...
                    if(name == "clientResponse" || name.equals("clientResponse")) {return VALUED_PARAM_clientResponse;}
break;
                case 7:
...
break;
                case 5:
                    ...
                    if(name == "clientResponse" || name.equals("clientResponse")) {return 0;}
break;
                case 7:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiRelayRunDbResponse0.class;
	}
...
break;
                case 5:
                    ...
                    if(name == "clientResponse" || name.equals("clientResponse")) {return true;}
break;
                case 7:
...
break;
                case 5:
                    ...
                    if(name == "clientResponse" || name.equals("clientResponse")) {return 41;}
break;
                case 7:
...
break;
    ...
    public com.f1.ami.amicommon.msg.AmiCenterResponse getClientResponse(){
        return this._clientResponse;
    }
    public void setClientResponse(com.f1.ami.amicommon.msg.AmiCenterResponse _clientResponse){
    
        this._clientResponse=_clientResponse;
    }
    ...
    private static final class VALUED_PARAM_CLASS_clientResponse extends AbstractValuedParam<AmiRelayRunDbResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiRelayRunDbResponse0 valued, DataOutput stream) throws IOException{
		    
		       throw new IOException("can not write to type to dataStream: com.f1.ami.amicommon.msg.AmiCenterResponse}");
		    
	    }
	    
	    @Override
	    public void read(AmiRelayRunDbResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiRelayRunDbResponse0 valued) {
		    return (com.f1.ami.amicommon.msg.AmiCenterResponse)((AmiRelayRunDbResponse0)valued).getClientResponse();
	    }
    
	    @Override
	    public void setValue(AmiRelayRunDbResponse0 valued, Object value) {
		    valued.setClientResponse((com.f1.ami.amicommon.msg.AmiCenterResponse)value);
	    }
    
	    @Override
	    public void copy(AmiRelayRunDbResponse0 source, AmiRelayRunDbResponse0 dest) {
		    dest.setClientResponse(source.getClientResponse());
	    }
	    
	    @Override
	    public boolean areEqual(AmiRelayRunDbResponse0 source, AmiRelayRunDbResponse0 dest) {
	        return OH.eq(dest.getClientResponse(),source.getClientResponse());
	    }
	    ...
	    public Class getReturnType() {
		    return com.f1.ami.amicommon.msg.AmiCenterResponse.class;
	    }
	    private static final Caster CASTER=OH.getCaster(com.f1.ami.amicommon.msg.AmiCenterResponse.class);
	    @Override
	    ...
	    @Override
	    public void append(AmiRelayRunDbResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getClientResponse());
	        
	    }
	    @Override
	    public void append(AmiRelayRunDbResponse0 valued, StringBuildable sb){
	    ...
	    public String toString(){
	        return "ValuedParam:com.f1.ami.amicommon.msg.AmiCenterResponse clientResponse";
	    }
	    @Override
	    public void clear(AmiRelayRunDbResponse0 valued){
	       valued.setClientResponse(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_clientResponse=new VALUED_PARAM_CLASS_clientResponse();
  

  
    private static final class VALUED_PARAM_CLASS_exception extends AbstractValuedParam<AmiRelayRunDbResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayRunDbResponse0 valued) {
		    return (java.lang.Exception)((AmiRelayRunDbResponse0)valued).getException();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiRelayRunDbResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayRunDbResponse0 valued) {
		    return (java.lang.String)((AmiRelayRunDbResponse0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_ok extends AbstractValuedParam<AmiRelayRunDbResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayRunDbResponse0 valued) {
		    return (boolean)((AmiRelayRunDbResponse0)valued).getOk();
	    }
	    ...
	    @Override
	    public boolean getBoolean(AmiRelayRunDbResponse0 valued) {
		    return valued.getOk();
	    }
    
	    @Override
	    public void setBoolean(AmiRelayRunDbResponse0 valued, boolean value) {
		    valued.setOk(value);
	    }
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_clientResponse, VALUED_PARAM_exception, VALUED_PARAM_message, VALUED_PARAM_ok, };



    private static final byte PIDS[]={ 2 ,44,43,42};
    
    @Override
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             case 2: return VALUED_PARAM_clientResponse;
    ...
    public Object ask(byte pid){
        switch(pid){
             case 2: return  this._clientResponse; 
    ...
    public Class askClass(byte pid){
        switch(pid){
             case 2: return com.f1.ami.amicommon.msg.AmiCenterResponse.class;
    ...
    public void put(byte pid,Object value){
        try{
        switch(pid){
             case 2: this._clientResponse=(com.f1.ami.amicommon.msg.AmiCenterResponse)value;return;
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             case 2: this._clientResponse=(com.f1.ami.amicommon.msg.AmiCenterResponse)value;return true;
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 2:
            ...
            this._clientResponse=(com.f1.ami.amicommon.msg.AmiCenterResponse)converter.read(session);
...
if(this._clientResponse!=null && (0 & transience)==0){
    out.writeByte(2);
        
    converter.write(this._clientResponse,session);
