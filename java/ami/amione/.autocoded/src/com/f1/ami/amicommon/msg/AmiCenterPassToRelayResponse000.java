...
public  class AmiCenterPassToRelayResponse000 extends com.f1.ami.amicommon.msg.AmiCenterPassToRelayResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public void setAgentResponse(com.f1.ami.amicommon.msg.AmiRelayResponse _agentResponse){
	    super.setAgentResponse(_agentResponse);
	    existing.set(0,true);
    }
    public boolean askExistsAgentResponse(){
	...
	public AmiCenterPassToRelayResponse000 nw(){
	    return new AmiCenterPassToRelayResponse000();
	}

	public AmiCenterPassToRelayResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterPassToRelayResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getAgentResponse(),session);
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 1:
                    ...
                    this.setAgentResponse((com.f1.ami.amicommon.msg.AmiRelayResponse)converter.read(session));
