...
public abstract class SingleParamMessage0 implements com.f1.ami.amicommon.msg.SingleParamMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "params" };
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "params" || name.equals("params")) {return 0;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
	...
	public Class<Valued> askType(){
	    return (Class)SingleParamMessage0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_params extends AbstractValuedParam<SingleParamMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(SingleParamMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(SingleParamMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(SingleParamMessage0 valued) {
		    return (byte[])((SingleParamMessage0)valued).getParams();
	    }
    
	    @Override
	    public void setValue(SingleParamMessage0 valued, Object value) {
		    valued.setParams((byte[])value);
	    }
    
	    @Override
	    public void copy(SingleParamMessage0 source, SingleParamMessage0 dest) {
		    dest.setParams(source.getParams());
	    }
	    
	    @Override
	    public boolean areEqual(SingleParamMessage0 source, SingleParamMessage0 dest) {
	    ...
	    @Override
	    public void append(SingleParamMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getParams());
	        
	    }
	    @Override
	    public void append(SingleParamMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(SingleParamMessage0 valued){
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_params, };



    private static final byte PIDS[]={ 4 };
