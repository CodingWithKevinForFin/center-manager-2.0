...
public abstract class AmiWebManagerGetFileResponse0 implements com.f1.ami.amicommon.msg.AmiWebManagerGetFileResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "exception" ,"file","message","ok","priority","progress","status","ticket","trackedEvents"};
...
break;
                case 15:
                    ...
                    if(name == "status" || name.equals("status")) {return 6;}
break;
                case 17:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiWebManagerGetFileResponse0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_exception extends AbstractValuedParam<AmiWebManagerGetFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiWebManagerGetFileResponse0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiWebManagerGetFileResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiWebManagerGetFileResponse0 valued) {
		    return (java.lang.Exception)((AmiWebManagerGetFileResponse0)valued).getException();
	    }
    
	    @Override
	    public void setValue(AmiWebManagerGetFileResponse0 valued, Object value) {
		    valued.setException((java.lang.Exception)value);
	    }
    
	    @Override
	    public void copy(AmiWebManagerGetFileResponse0 source, AmiWebManagerGetFileResponse0 dest) {
		    dest.setException(source.getException());
	    }
	    
	    @Override
	    public boolean areEqual(AmiWebManagerGetFileResponse0 source, AmiWebManagerGetFileResponse0 dest) {
	    ...
	    @Override
	    public void append(AmiWebManagerGetFileResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getException());
	        
	    }
	    @Override
	    public void append(AmiWebManagerGetFileResponse0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiWebManagerGetFileResponse0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_file extends AbstractValuedParam<AmiWebManagerGetFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerGetFileResponse0 valued) {
		    return (com.f1.ami.amicommon.msg.AmiFileMessage)((AmiWebManagerGetFileResponse0)valued).getFile();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiWebManagerGetFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerGetFileResponse0 valued) {
		    return (java.lang.String)((AmiWebManagerGetFileResponse0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_ok extends AbstractValuedParam<AmiWebManagerGetFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerGetFileResponse0 valued) {
		    return (boolean)((AmiWebManagerGetFileResponse0)valued).getOk();
	    }
	    ...
	    @Override
	    public boolean getBoolean(AmiWebManagerGetFileResponse0 valued) {
		    return valued.getOk();
	    }
    
	    @Override
	    public void setBoolean(AmiWebManagerGetFileResponse0 valued, boolean value) {
		    valued.setOk(value);
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiWebManagerGetFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerGetFileResponse0 valued) {
		    return (int)((AmiWebManagerGetFileResponse0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiWebManagerGetFileResponse0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiWebManagerGetFileResponse0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_progress extends AbstractValuedParam<AmiWebManagerGetFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerGetFileResponse0 valued) {
		    return (double)((AmiWebManagerGetFileResponse0)valued).getProgress();
	    }
	    ...
	    @Override
	    public double getDouble(AmiWebManagerGetFileResponse0 valued) {
		    return valued.getProgress();
	    }
    
	    @Override
	    public void setDouble(AmiWebManagerGetFileResponse0 valued, double value) {
    ...
    private static final class VALUED_PARAM_CLASS_status extends AbstractValuedParam<AmiWebManagerGetFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerGetFileResponse0 valued) {
		    return (byte)((AmiWebManagerGetFileResponse0)valued).getStatus();
	    }
	    ...
	    @Override
	    public byte getByte(AmiWebManagerGetFileResponse0 valued) {
		    return valued.getStatus();
	    }
    
	    @Override
	    public void setByte(AmiWebManagerGetFileResponse0 valued, byte value) {
    ...
    private static final class VALUED_PARAM_CLASS_ticket extends AbstractValuedParam<AmiWebManagerGetFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerGetFileResponse0 valued) {
		    return (java.lang.String)((AmiWebManagerGetFileResponse0)valued).getTicket();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_trackedEvents extends AbstractValuedParam<AmiWebManagerGetFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerGetFileResponse0 valued) {
		    return (java.util.List)((AmiWebManagerGetFileResponse0)valued).getTrackedEvents();
	    }
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_exception, VALUED_PARAM_file, VALUED_PARAM_message, VALUED_PARAM_ok, VALUED_PARAM_priority, VALUED_PARAM_progress, VALUED_PARAM_status, VALUED_PARAM_ticket, VALUED_PARAM_trackedEvents, };
