...
public abstract class AmiRelaySendEmailResponse0 implements com.f1.ami.amicommon.msg.AmiRelaySendEmailResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "exception" ,"message","ok"};
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiRelaySendEmailResponse0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_exception extends AbstractValuedParam<AmiRelaySendEmailResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiRelaySendEmailResponse0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiRelaySendEmailResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiRelaySendEmailResponse0 valued) {
		    return (java.lang.Exception)((AmiRelaySendEmailResponse0)valued).getException();
	    }
    
	    @Override
	    public void setValue(AmiRelaySendEmailResponse0 valued, Object value) {
		    valued.setException((java.lang.Exception)value);
	    }
    
	    @Override
	    public void copy(AmiRelaySendEmailResponse0 source, AmiRelaySendEmailResponse0 dest) {
		    dest.setException(source.getException());
	    }
	    
	    @Override
	    public boolean areEqual(AmiRelaySendEmailResponse0 source, AmiRelaySendEmailResponse0 dest) {
	    ...
	    @Override
	    public void append(AmiRelaySendEmailResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getException());
	        
	    }
	    @Override
	    public void append(AmiRelaySendEmailResponse0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiRelaySendEmailResponse0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiRelaySendEmailResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelaySendEmailResponse0 valued) {
		    return (java.lang.String)((AmiRelaySendEmailResponse0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_ok extends AbstractValuedParam<AmiRelaySendEmailResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelaySendEmailResponse0 valued) {
		    return (boolean)((AmiRelaySendEmailResponse0)valued).getOk();
	    }
	    ...
	    @Override
	    public boolean getBoolean(AmiRelaySendEmailResponse0 valued) {
		    return valued.getOk();
	    }
    
	    @Override
	    public void setBoolean(AmiRelaySendEmailResponse0 valued, boolean value) {
		    valued.setOk(value);
	    }
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_exception, VALUED_PARAM_message, VALUED_PARAM_ok, };



    private static final byte PIDS[]={ 44 ,43,42};
