...
public abstract class AmiCenterPassToRelayResponse0 implements com.f1.ami.amicommon.msg.AmiCenterPassToRelayResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private com.f1.ami.amicommon.msg.AmiRelayResponse _agentResponse;
    ...
    private static final String NAMES[]={ "agentResponse" ,"exception","message","ok","priority","progress","ticket","trackedEvents"};
...
break;
                case 6:
                    ...
                    if(name == "agentResponse" || name.equals("agentResponse")) {this._agentResponse=(com.f1.ami.amicommon.msg.AmiRelayResponse)value;return;}
break;
                case 7:
...
break;
                case 6:
                    ...
                    if(name == "agentResponse" || name.equals("agentResponse")) {this._agentResponse=(com.f1.ami.amicommon.msg.AmiRelayResponse)value;return true;}
break;
                case 7:
...
break;
                case 6:
                    ...
                    if(name == "agentResponse" || name.equals("agentResponse")) {return this._agentResponse;}
...
break;
                case 6:
                    ...
                    if(name == "agentResponse" || name.equals("agentResponse")) {return com.f1.ami.amicommon.msg.AmiRelayResponse.class;}
break;
                case 7:
...
break;
                case 6:
                    ...
                    if(name == "agentResponse" || name.equals("agentResponse")) {return VALUED_PARAM_agentResponse;}
break;
                case 7:
...
break;
                case 6:
                    ...
                    if(name == "agentResponse" || name.equals("agentResponse")) {return 0;}
break;
                case 7:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterPassToRelayResponse0.class;
	}
...
break;
                case 6:
                    ...
                    if(name == "agentResponse" || name.equals("agentResponse")) {return true;}
break;
                case 7:
...
break;
                case 6:
                    ...
                    if(name == "agentResponse" || name.equals("agentResponse")) {return 41;}
break;
                case 7:
...
break;
    ...
    public com.f1.ami.amicommon.msg.AmiRelayResponse getAgentResponse(){
        return this._agentResponse;
    }
    public void setAgentResponse(com.f1.ami.amicommon.msg.AmiRelayResponse _agentResponse){
    
        this._agentResponse=_agentResponse;
    }
    ...
    private static final class VALUED_PARAM_CLASS_agentResponse extends AbstractValuedParam<AmiCenterPassToRelayResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterPassToRelayResponse0 valued, DataOutput stream) throws IOException{
		    
		       throw new IOException("can not write to type to dataStream: com.f1.ami.amicommon.msg.AmiRelayResponse}");
		    
	    }
	    
	    @Override
	    public void read(AmiCenterPassToRelayResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayResponse0 valued) {
		    return (com.f1.ami.amicommon.msg.AmiRelayResponse)((AmiCenterPassToRelayResponse0)valued).getAgentResponse();
	    }
    
	    @Override
	    public void setValue(AmiCenterPassToRelayResponse0 valued, Object value) {
		    valued.setAgentResponse((com.f1.ami.amicommon.msg.AmiRelayResponse)value);
	    }
    
	    @Override
	    public void copy(AmiCenterPassToRelayResponse0 source, AmiCenterPassToRelayResponse0 dest) {
		    dest.setAgentResponse(source.getAgentResponse());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterPassToRelayResponse0 source, AmiCenterPassToRelayResponse0 dest) {
	        return OH.eq(dest.getAgentResponse(),source.getAgentResponse());
	    }
	    ...
	    public Class getReturnType() {
		    return com.f1.ami.amicommon.msg.AmiRelayResponse.class;
	    }
	    private static final Caster CASTER=OH.getCaster(com.f1.ami.amicommon.msg.AmiRelayResponse.class);
	    @Override
	    ...
	    @Override
	    public void append(AmiCenterPassToRelayResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getAgentResponse());
	        
	    }
	    @Override
	    public void append(AmiCenterPassToRelayResponse0 valued, StringBuildable sb){
	    ...
	    public String toString(){
	        return "ValuedParam:com.f1.ami.amicommon.msg.AmiRelayResponse agentResponse";
	    }
	    @Override
	    public void clear(AmiCenterPassToRelayResponse0 valued){
	       valued.setAgentResponse(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_agentResponse=new VALUED_PARAM_CLASS_agentResponse();
  

  
    private static final class VALUED_PARAM_CLASS_exception extends AbstractValuedParam<AmiCenterPassToRelayResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayResponse0 valued) {
		    return (java.lang.Exception)((AmiCenterPassToRelayResponse0)valued).getException();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiCenterPassToRelayResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayResponse0 valued) {
		    return (java.lang.String)((AmiCenterPassToRelayResponse0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_ok extends AbstractValuedParam<AmiCenterPassToRelayResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayResponse0 valued) {
		    return (boolean)((AmiCenterPassToRelayResponse0)valued).getOk();
	    }
	    ...
	    @Override
	    public boolean getBoolean(AmiCenterPassToRelayResponse0 valued) {
		    return valued.getOk();
	    }
    
	    @Override
	    public void setBoolean(AmiCenterPassToRelayResponse0 valued, boolean value) {
		    valued.setOk(value);
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiCenterPassToRelayResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayResponse0 valued) {
		    return (int)((AmiCenterPassToRelayResponse0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiCenterPassToRelayResponse0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiCenterPassToRelayResponse0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_progress extends AbstractValuedParam<AmiCenterPassToRelayResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayResponse0 valued) {
		    return (double)((AmiCenterPassToRelayResponse0)valued).getProgress();
	    }
	    ...
	    @Override
	    public double getDouble(AmiCenterPassToRelayResponse0 valued) {
		    return valued.getProgress();
	    }
    
	    @Override
	    public void setDouble(AmiCenterPassToRelayResponse0 valued, double value) {
    ...
    private static final class VALUED_PARAM_CLASS_ticket extends AbstractValuedParam<AmiCenterPassToRelayResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayResponse0 valued) {
		    return (java.lang.String)((AmiCenterPassToRelayResponse0)valued).getTicket();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_trackedEvents extends AbstractValuedParam<AmiCenterPassToRelayResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterPassToRelayResponse0 valued) {
		    return (java.util.List)((AmiCenterPassToRelayResponse0)valued).getTrackedEvents();
	    }
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_agentResponse, VALUED_PARAM_exception, VALUED_PARAM_message, VALUED_PARAM_ok, VALUED_PARAM_priority, VALUED_PARAM_progress, VALUED_PARAM_ticket, VALUED_PARAM_trackedEvents, };



    private static final byte PIDS[]={ 1 ,44,43,42,57,53,55,58};
    
    @Override
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             case 1: return VALUED_PARAM_agentResponse;
    ...
    public byte askPid(String name){
             if(name=="agentResponse") return 1;
             ...
             if("agentResponse".equals(name)) return 1;
    ...
    public Object ask(byte pid){
        switch(pid){
             case 1: return  this._agentResponse; 
    ...
    public Class askClass(byte pid){
        switch(pid){
             case 1: return com.f1.ami.amicommon.msg.AmiRelayResponse.class;
    ...
    public void put(byte pid,Object value){
        try{
        switch(pid){
             case 1: this._agentResponse=(com.f1.ami.amicommon.msg.AmiRelayResponse)value;return;
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             case 1: this._agentResponse=(com.f1.ami.amicommon.msg.AmiRelayResponse)value;return true;
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 1:
            ...
            this._agentResponse=(com.f1.ami.amicommon.msg.AmiRelayResponse)converter.read(session);
...
if(this._agentResponse!=null && (0 & transience)==0){
    out.writeByte(1);
        
    converter.write(this._agentResponse,session);
