...
public abstract class AmiCenterStatusResponse0 implements com.f1.ami.amicommon.msg.AmiCenterStatusResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterStatusResponse0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_exception extends AbstractValuedParam<AmiCenterStatusResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterStatusResponse0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterStatusResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterStatusResponse0 valued) {
		    return (java.lang.Exception)((AmiCenterStatusResponse0)valued).getException();
	    }
    
	    @Override
	    public void setValue(AmiCenterStatusResponse0 valued, Object value) {
		    valued.setException((java.lang.Exception)value);
	    }
    
	    @Override
	    public void copy(AmiCenterStatusResponse0 source, AmiCenterStatusResponse0 dest) {
		    dest.setException(source.getException());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterStatusResponse0 source, AmiCenterStatusResponse0 dest) {
	    ...
	    @Override
	    public void append(AmiCenterStatusResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getException());
	        
	    }
	    @Override
	    public void append(AmiCenterStatusResponse0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiCenterStatusResponse0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiCenterStatusResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterStatusResponse0 valued) {
		    return (java.lang.String)((AmiCenterStatusResponse0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_ok extends AbstractValuedParam<AmiCenterStatusResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterStatusResponse0 valued) {
		    return (boolean)((AmiCenterStatusResponse0)valued).getOk();
	    }
	    ...
	    @Override
	    public boolean getBoolean(AmiCenterStatusResponse0 valued) {
		    return valued.getOk();
	    }
    
	    @Override
	    public void setBoolean(AmiCenterStatusResponse0 valued, boolean value) {
		    valued.setOk(value);
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiCenterStatusResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterStatusResponse0 valued) {
		    return (int)((AmiCenterStatusResponse0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiCenterStatusResponse0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiCenterStatusResponse0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_progress extends AbstractValuedParam<AmiCenterStatusResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterStatusResponse0 valued) {
		    return (double)((AmiCenterStatusResponse0)valued).getProgress();
	    }
	    ...
	    @Override
	    public double getDouble(AmiCenterStatusResponse0 valued) {
		    return valued.getProgress();
	    }
    
	    @Override
	    public void setDouble(AmiCenterStatusResponse0 valued, double value) {
    ...
    private static final class VALUED_PARAM_CLASS_ticket extends AbstractValuedParam<AmiCenterStatusResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterStatusResponse0 valued) {
		    return (java.lang.String)((AmiCenterStatusResponse0)valued).getTicket();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_trackedEvents extends AbstractValuedParam<AmiCenterStatusResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterStatusResponse0 valued) {
		    return (java.util.List)((AmiCenterStatusResponse0)valued).getTrackedEvents();
	    }
