...
public abstract class AmiCenterClientMsgStatusMessage0 implements com.f1.ami.amicommon.centerclient.AmiCenterClientMsgStatusMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,Cloneable{
    ...
    private com.f1.povo.msg.MsgStatusMessage _msgStatusMessage;

    private static final String NAMES[]={ "centerId" ,"msgStatusMessage"};
...
break;
                case 2:
                    ...
                    if(name == "msgStatusMessage" || name.equals("msgStatusMessage")) {this._msgStatusMessage=(com.f1.povo.msg.MsgStatusMessage)value;return;}
break;
        }
...
break;
                case 2:
                    ...
                    if(name == "msgStatusMessage" || name.equals("msgStatusMessage")) {this._msgStatusMessage=(com.f1.povo.msg.MsgStatusMessage)value;return true;}
break;
        }
        return false;
    }
...
break;
                case 2:
                    ...
                    if(name == "msgStatusMessage" || name.equals("msgStatusMessage")) {return this._msgStatusMessage;}
...
break;
                case 2:
                    ...
                    if(name == "msgStatusMessage" || name.equals("msgStatusMessage")) {return com.f1.povo.msg.MsgStatusMessage.class;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
...
break;
                case 2:
                    ...
                    if(name == "msgStatusMessage" || name.equals("msgStatusMessage")) {return VALUED_PARAM_msgStatusMessage;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
...
break;
                case 2:
                    ...
                    if(name == "msgStatusMessage" || name.equals("msgStatusMessage")) {return 1;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterClientMsgStatusMessage0.class;
	}
...
break;
                case 2:
                    ...
                    if(name == "msgStatusMessage" || name.equals("msgStatusMessage")) {return true;}
break;
        }
        return false;
    }
...
break;
                case 2:
                    ...
                    if(name == "msgStatusMessage" || name.equals("msgStatusMessage")) {return 41;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public Object askAtPosition(int position){
        ...
        case 1:return _msgStatusMessage;
    ...
    public com.f1.povo.msg.MsgStatusMessage getMsgStatusMessage(){
        return this._msgStatusMessage;
    }
    public void setMsgStatusMessage(com.f1.povo.msg.MsgStatusMessage _msgStatusMessage){
    
        this._msgStatusMessage=_msgStatusMessage;
    }
    ...
    private static final class VALUED_PARAM_CLASS_centerId extends AbstractValuedParam<AmiCenterClientMsgStatusMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterClientMsgStatusMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterClientMsgStatusMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterClientMsgStatusMessage0 valued) {
		    return (byte)((AmiCenterClientMsgStatusMessage0)valued).getCenterId();
	    }
    
	    @Override
	    public void setValue(AmiCenterClientMsgStatusMessage0 valued, Object value) {
		    valued.setCenterId((java.lang.Byte)value);
	    }
    
	    @Override
	    public void copy(AmiCenterClientMsgStatusMessage0 source, AmiCenterClientMsgStatusMessage0 dest) {
		    dest.setCenterId(source.getCenterId());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterClientMsgStatusMessage0 source, AmiCenterClientMsgStatusMessage0 dest) {
	    ...
	    @Override
	    public byte getByte(AmiCenterClientMsgStatusMessage0 valued) {
		    return valued.getCenterId();
	    }
    
	    @Override
	    public void setByte(AmiCenterClientMsgStatusMessage0 valued, byte value) {
	    ...
	    @Override
	    public void append(AmiCenterClientMsgStatusMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getCenterId());
	        
	    }
	    @Override
	    public void append(AmiCenterClientMsgStatusMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiCenterClientMsgStatusMessage0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_msgStatusMessage extends AbstractValuedParam<AmiCenterClientMsgStatusMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    public void write(AmiCenterClientMsgStatusMessage0 valued, DataOutput stream) throws IOException{
		       ...
		       throw new IOException("can not write to type to dataStream: com.f1.povo.msg.MsgStatusMessage}");
	    ...
	    @Override
	    public String getName() {
            return "msgStatusMessage";
	    }
    
	    @Override
	    public Object getValue(AmiCenterClientMsgStatusMessage0 valued) {
		    return (com.f1.povo.msg.MsgStatusMessage)((AmiCenterClientMsgStatusMessage0)valued).getMsgStatusMessage();
	    }
    
	    @Override
	    public void setValue(AmiCenterClientMsgStatusMessage0 valued, Object value) {
		    valued.setMsgStatusMessage((com.f1.povo.msg.MsgStatusMessage)value);
	    }
    
	    @Override
	    public void copy(AmiCenterClientMsgStatusMessage0 source, AmiCenterClientMsgStatusMessage0 dest) {
		    dest.setMsgStatusMessage(source.getMsgStatusMessage());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterClientMsgStatusMessage0 source, AmiCenterClientMsgStatusMessage0 dest) {
	        return OH.eq(dest.getMsgStatusMessage(),source.getMsgStatusMessage());
	    }
	    ...
	    @Override
	    public Class getReturnType() {
		    return com.f1.povo.msg.MsgStatusMessage.class;
	    }
	    private static final Caster CASTER=OH.getCaster(com.f1.povo.msg.MsgStatusMessage.class);
	    @Override
	    public Caster getCaster() {
		    return CASTER;
	    }
	    ...
	    public void append(AmiCenterClientMsgStatusMessage0 valued, StringBuilder sb){
	        ...
	        sb.append(valued.getMsgStatusMessage());
	    ...
	    @Override
	    public String toString(){
	        return "ValuedParam:com.f1.povo.msg.MsgStatusMessage msgStatusMessage";
	    }
	    @Override
	    public void clear(AmiCenterClientMsgStatusMessage0 valued){
	       valued.setMsgStatusMessage(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_msgStatusMessage=new VALUED_PARAM_CLASS_msgStatusMessage();
  


    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_centerId, VALUED_PARAM_msgStatusMessage, };
