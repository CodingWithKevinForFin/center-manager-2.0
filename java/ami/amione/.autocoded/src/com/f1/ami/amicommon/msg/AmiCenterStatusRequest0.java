...
public abstract class AmiCenterStatusRequest0 implements com.f1.ami.amicommon.msg.AmiCenterStatusRequest ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterStatusRequest0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_comment extends AbstractValuedParam<AmiCenterStatusRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterStatusRequest0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterStatusRequest0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterStatusRequest0 valued) {
		    return (java.lang.String)((AmiCenterStatusRequest0)valued).getComment();
	    }
    
	    @Override
	    public void setValue(AmiCenterStatusRequest0 valued, Object value) {
		    valued.setComment((java.lang.String)value);
	    }
    
	    @Override
	    public void copy(AmiCenterStatusRequest0 source, AmiCenterStatusRequest0 dest) {
		    dest.setComment(source.getComment());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterStatusRequest0 source, AmiCenterStatusRequest0 dest) {
	    ...
	    @Override
	    public void append(AmiCenterStatusRequest0 valued, StringBuilder sb){
	        
	           SH.quote('"',valued.getComment(),sb);
	        
	    }
	    @Override
	    public void append(AmiCenterStatusRequest0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiCenterStatusRequest0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_invokedBy extends AbstractValuedParam<AmiCenterStatusRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterStatusRequest0 valued) {
		    return (java.lang.String)((AmiCenterStatusRequest0)valued).getInvokedBy();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiCenterStatusRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterStatusRequest0 valued) {
		    return (int)((AmiCenterStatusRequest0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiCenterStatusRequest0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiCenterStatusRequest0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_requestTime extends AbstractValuedParam<AmiCenterStatusRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterStatusRequest0 valued) {
		    return (long)((AmiCenterStatusRequest0)valued).getRequestTime();
	    }
	    ...
	    @Override
	    public long getLong(AmiCenterStatusRequest0 valued) {
		    return valued.getRequestTime();
	    }
    
	    @Override
	    public void setLong(AmiCenterStatusRequest0 valued, long value) {
