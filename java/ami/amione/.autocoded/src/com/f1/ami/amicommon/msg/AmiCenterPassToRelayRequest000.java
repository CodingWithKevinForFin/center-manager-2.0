...
public  class AmiCenterPassToRelayRequest000 extends com.f1.ami.amicommon.msg.AmiCenterPassToRelayRequest00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public void setAgentRequest(com.f1.ami.amicommon.msg.AmiRelayRequest _agentRequest){
	    super.setAgentRequest(_agentRequest);
	    existing.set(0,true);
    }
    public boolean askExistsAgentRequest(){
    ...
    public void setRelayMiid(long _relayMiid){
	    super.setRelayMiid(_relayMiid);
	    existing.set(4,true);
    }
    public boolean askExistsRelayMiid(){
	...
	public AmiCenterPassToRelayRequest000 nw(){
	    return new AmiCenterPassToRelayRequest000();
	}

	public AmiCenterPassToRelayRequest000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterPassToRelayRequest000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getAgentRequest(),session);
    ...
    out.writeByte(6);
    out.writeLong(this.getRelayMiid());
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 1:
                    ...
                    this.setAgentRequest((com.f1.ami.amicommon.msg.AmiRelayRequest)converter.read(session));
