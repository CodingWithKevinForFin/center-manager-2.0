...
public  class AmiRelayOnConnectResponse000 extends com.f1.ami.amicommon.msg.AmiRelayOnConnectResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public void setAmiServerPort(int _amiServerPort){
	    super.setAmiServerPort(_amiServerPort);
	    existing.set(0,true);
    }
    public boolean askExistsAmiServerPort(){
    ...
    public void setGuaranteedMessagingEnabled(boolean _guaranteedMessagingEnabled){
	    super.setGuaranteedMessagingEnabled(_guaranteedMessagingEnabled);
	    existing.set(3,true);
    }
    public boolean askExistsGuaranteedMessagingEnabled(){
	    return existing.get(3);
    }

	@Override
    public void setHostname(java.lang.String _hostname){
	    super.setHostname(_hostname);
	    existing.set(4,true);
    }
    public boolean askExistsHostname(){
	    return existing.get(4);
    }

	@Override
    public void setMachineUid(java.lang.String _machineUid){
	    super.setMachineUid(_machineUid);
	    existing.set(5,true);
    }
    public boolean askExistsMachineUid(){
    ...
    public void setStartTime(long _startTime){
	    super.setStartTime(_startTime);
	    existing.set(10,true);
    }
    public boolean askExistsStartTime(){
	...
	public AmiRelayOnConnectResponse000 nw(){
	    return new AmiRelayOnConnectResponse000();
	}

	public AmiRelayOnConnectResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiRelayOnConnectResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getMachineUid(),session);
    ...
    out.writeByte(4);
    out.writeInt(this.getAmiServerPort());
    ...
    converter.write(this.getHostname(),session);
    ...
    out.writeByte(0);
    out.writeBoolean(this.getGuaranteedMessagingEnabled());
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 2:
                    ...
                    this.setMachineUid((java.lang.String)converter.read(session));
                ...
                case 4:
                    ...
                    if((basicType=in.readByte())!=4)
                        break;
                    this.setAmiServerPort(in.readInt());
                ...
                case 6:
                    ...
                    this.setHostname((java.lang.String)converter.read(session));
                ...
                case 9:
                    ...
                    if((basicType=in.readByte())!=0)
                        break;
                    this.setGuaranteedMessagingEnabled(in.readBoolean());
