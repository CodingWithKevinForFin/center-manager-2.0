...
public abstract class AmiWebManagerProcessSpecialFileResponse0 implements com.f1.ami.amicommon.msg.AmiWebManagerProcessSpecialFileResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private com.f1.base.Table _results;

    private java.lang.String _ticket;

    private java.util.List _trackedEvents;

    private static final String NAMES[]={ "exception" ,"message","ok","priority","progress","results","ticket","trackedEvents"};
...
break;
                case 13:
                    ...
                    if(name == "results" || name.equals("results")) {this._results=(com.f1.base.Table)value;return;}
break;
                case 18:
...
break;
                case 13:
                    ...
                    if(name == "results" || name.equals("results")) {this._results=(com.f1.base.Table)value;return true;}
break;
                case 18:
...
break;
                case 13:
                    ...
                    if(name == "results" || name.equals("results")) {return this._results;}
...
break;
                case 13:
                    ...
                    if(name == "results" || name.equals("results")) {return com.f1.base.Table.class;}
break;
                case 18:
...
break;
                case 13:
                    ...
                    if(name == "results" || name.equals("results")) {return VALUED_PARAM_results;}
break;
                case 18:
...
break;
                case 7:
                    ...
                    if(name == "progress" || name.equals("progress")) {return 4;}
break;
                case 13:

                    if(name == "results" || name.equals("results")) {return 5;}
break;
                case 18:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiWebManagerProcessSpecialFileResponse0.class;
	}
...
break;
                case 13:
                    ...
                    if(name == "results" || name.equals("results")) {return true;}
break;
                case 18:
...
break;
                case 13:
                    ...
                    if(name == "results" || name.equals("results")) {return 43;}
break;
                case 18:
...
break;
    ...
    public Object askAtPosition(int position){
        ...
        case 4:return _progress;

        case 5:return _results;
    ...
    public com.f1.base.Table getResults(){
        return this._results;
    }
    public void setResults(com.f1.base.Table _results){
    ...
    private static final class VALUED_PARAM_CLASS_exception extends AbstractValuedParam<AmiWebManagerProcessSpecialFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiWebManagerProcessSpecialFileResponse0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiWebManagerProcessSpecialFileResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileResponse0 valued) {
		    return (java.lang.Exception)((AmiWebManagerProcessSpecialFileResponse0)valued).getException();
	    }
    
	    @Override
	    public void setValue(AmiWebManagerProcessSpecialFileResponse0 valued, Object value) {
		    valued.setException((java.lang.Exception)value);
	    }
    
	    @Override
	    public void copy(AmiWebManagerProcessSpecialFileResponse0 source, AmiWebManagerProcessSpecialFileResponse0 dest) {
		    dest.setException(source.getException());
	    }
	    
	    @Override
	    public boolean areEqual(AmiWebManagerProcessSpecialFileResponse0 source, AmiWebManagerProcessSpecialFileResponse0 dest) {
	    ...
	    @Override
	    public void append(AmiWebManagerProcessSpecialFileResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getException());
	        
	    }
	    @Override
	    public void append(AmiWebManagerProcessSpecialFileResponse0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiWebManagerProcessSpecialFileResponse0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiWebManagerProcessSpecialFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileResponse0 valued) {
		    return (java.lang.String)((AmiWebManagerProcessSpecialFileResponse0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_ok extends AbstractValuedParam<AmiWebManagerProcessSpecialFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileResponse0 valued) {
		    return (boolean)((AmiWebManagerProcessSpecialFileResponse0)valued).getOk();
	    }
	    ...
	    @Override
	    public boolean getBoolean(AmiWebManagerProcessSpecialFileResponse0 valued) {
		    return valued.getOk();
	    }
    
	    @Override
	    public void setBoolean(AmiWebManagerProcessSpecialFileResponse0 valued, boolean value) {
		    valued.setOk(value);
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiWebManagerProcessSpecialFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileResponse0 valued) {
		    return (int)((AmiWebManagerProcessSpecialFileResponse0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiWebManagerProcessSpecialFileResponse0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiWebManagerProcessSpecialFileResponse0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_progress extends AbstractValuedParam<AmiWebManagerProcessSpecialFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileResponse0 valued) {
		    return (double)((AmiWebManagerProcessSpecialFileResponse0)valued).getProgress();
	    }
	    ...
	    @Override
	    public double getDouble(AmiWebManagerProcessSpecialFileResponse0 valued) {
		    return valued.getProgress();
	    }
    
	    @Override
	    public void setDouble(AmiWebManagerProcessSpecialFileResponse0 valued, double value) {
    ...
    private static final class VALUED_PARAM_CLASS_results extends AbstractValuedParam<AmiWebManagerProcessSpecialFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileResponse0 valued) {
		    return (com.f1.base.Table)((AmiWebManagerProcessSpecialFileResponse0)valued).getResults();
	    }
    
	    @Override
	    public void setValue(AmiWebManagerProcessSpecialFileResponse0 valued, Object value) {
		    valued.setResults((com.f1.base.Table)value);
	    }
    
	    @Override
	    public void copy(AmiWebManagerProcessSpecialFileResponse0 source, AmiWebManagerProcessSpecialFileResponse0 dest) {
		    dest.setResults(source.getResults());
	    }
	    
	    @Override
	    public boolean areEqual(AmiWebManagerProcessSpecialFileResponse0 source, AmiWebManagerProcessSpecialFileResponse0 dest) {
	        return OH.eq(dest.getResults(),source.getResults());
	    }
	    ...
	    @Override
	    public String toString(){
	        return "ValuedParam:com.f1.base.Table results";
	    }
	    @Override
	    public void clear(AmiWebManagerProcessSpecialFileResponse0 valued){
	       valued.setResults(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_results=new VALUED_PARAM_CLASS_results();
  

  
    private static final class VALUED_PARAM_CLASS_ticket extends AbstractValuedParam<AmiWebManagerProcessSpecialFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileResponse0 valued) {
		    return (java.lang.String)((AmiWebManagerProcessSpecialFileResponse0)valued).getTicket();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_trackedEvents extends AbstractValuedParam<AmiWebManagerProcessSpecialFileResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiWebManagerProcessSpecialFileResponse0 valued) {
		    return (java.util.List)((AmiWebManagerProcessSpecialFileResponse0)valued).getTrackedEvents();
	    }
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_exception, VALUED_PARAM_message, VALUED_PARAM_ok, VALUED_PARAM_priority, VALUED_PARAM_progress, VALUED_PARAM_results, VALUED_PARAM_ticket, VALUED_PARAM_trackedEvents, };



    private static final byte PIDS[]={ 44 ,43,42,57,53,1,55,58};
    ...
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             ...
             case 1: return VALUED_PARAM_results;
    ...
    public byte askPid(String name){
             ...
             if("results".equals(name)) return 1;
    ...
    public void put(byte pid,Object value){
        ...
        switch(pid){
             ...
             case 1: this._results=(com.f1.base.Table)value;return;
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             ...
             case 1: this._results=(com.f1.base.Table)value;return true;
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 1:
            ...
            this._results=(com.f1.base.Table)converter.read(session);
...
if(this._results!=null && (0 & transience)==0){
    out.writeByte(1);
        
    converter.write(this._results,session);
