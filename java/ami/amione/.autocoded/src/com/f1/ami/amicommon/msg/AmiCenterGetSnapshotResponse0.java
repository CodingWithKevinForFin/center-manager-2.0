...
public abstract class AmiCenterGetSnapshotResponse0 implements com.f1.ami.amicommon.msg.AmiCenterGetSnapshotResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private com.f1.ami.amicommon.msg.AmiCenterChanges _snapshot;

    private java.lang.String _ticket;

    private java.util.List _trackedEvents;

    private static final String NAMES[]={ "exception" ,"message","ok","priority","processUid","progress","snapshot","ticket","trackedEvents"};
...
break;
                case 6:
                    ...
                    if(name == "snapshot" || name.equals("snapshot")) {this._snapshot=(com.f1.ami.amicommon.msg.AmiCenterChanges)value;return;}
break;
                case 7:
...
break;
                case 6:
                    ...
                    if(name == "snapshot" || name.equals("snapshot")) {this._snapshot=(com.f1.ami.amicommon.msg.AmiCenterChanges)value;return true;}
break;
                case 7:
...
break;
                case 6:
                    ...
                    if(name == "snapshot" || name.equals("snapshot")) {return this._snapshot;}
...
break;
                case 6:
                    ...
                    if(name == "snapshot" || name.equals("snapshot")) {return com.f1.ami.amicommon.msg.AmiCenterChanges.class;}
break;
                case 7:
...
break;
                case 6:
                    ...
                    if(name == "snapshot" || name.equals("snapshot")) {return VALUED_PARAM_snapshot;}
break;
                case 7:
...
break;
                case 2:
                    ...
                    if(name == "ok" || name.equals("ok")) {return 2;}
break;
                case 3:
...
break;
                case 6:
                    ...
                    if(name == "snapshot" || name.equals("snapshot")) {return 6;}
break;
                case 7:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterGetSnapshotResponse0.class;
	}
...
break;
                case 6:
                    ...
                    if(name == "snapshot" || name.equals("snapshot")) {return true;}
break;
                case 7:
...
break;
                case 6:
                    ...
                    if(name == "snapshot" || name.equals("snapshot")) {return 41;}
break;
                case 7:
...
break;
    ...
    public com.f1.ami.amicommon.msg.AmiCenterChanges getSnapshot(){
        return this._snapshot;
    }
    public void setSnapshot(com.f1.ami.amicommon.msg.AmiCenterChanges _snapshot){
    ...
    private static final class VALUED_PARAM_CLASS_exception extends AbstractValuedParam<AmiCenterGetSnapshotResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterGetSnapshotResponse0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterGetSnapshotResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterGetSnapshotResponse0 valued) {
		    return (java.lang.Exception)((AmiCenterGetSnapshotResponse0)valued).getException();
	    }
    
	    @Override
	    public void setValue(AmiCenterGetSnapshotResponse0 valued, Object value) {
		    valued.setException((java.lang.Exception)value);
	    }
    
	    @Override
	    public void copy(AmiCenterGetSnapshotResponse0 source, AmiCenterGetSnapshotResponse0 dest) {
		    dest.setException(source.getException());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterGetSnapshotResponse0 source, AmiCenterGetSnapshotResponse0 dest) {
	    ...
	    @Override
	    public void append(AmiCenterGetSnapshotResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getException());
	        
	    }
	    @Override
	    public void append(AmiCenterGetSnapshotResponse0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiCenterGetSnapshotResponse0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiCenterGetSnapshotResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterGetSnapshotResponse0 valued) {
		    return (java.lang.String)((AmiCenterGetSnapshotResponse0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_ok extends AbstractValuedParam<AmiCenterGetSnapshotResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterGetSnapshotResponse0 valued) {
		    return (boolean)((AmiCenterGetSnapshotResponse0)valued).getOk();
	    }
	    ...
	    @Override
	    public boolean getBoolean(AmiCenterGetSnapshotResponse0 valued) {
		    return valued.getOk();
	    }
    
	    @Override
	    public void setBoolean(AmiCenterGetSnapshotResponse0 valued, boolean value) {
		    valued.setOk(value);
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiCenterGetSnapshotResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterGetSnapshotResponse0 valued) {
		    return (int)((AmiCenterGetSnapshotResponse0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiCenterGetSnapshotResponse0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiCenterGetSnapshotResponse0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_processUid extends AbstractValuedParam<AmiCenterGetSnapshotResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterGetSnapshotResponse0 valued) {
		    return (java.lang.String)((AmiCenterGetSnapshotResponse0)valued).getProcessUid();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_progress extends AbstractValuedParam<AmiCenterGetSnapshotResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterGetSnapshotResponse0 valued) {
		    return (double)((AmiCenterGetSnapshotResponse0)valued).getProgress();
	    }
	    ...
	    @Override
	    public double getDouble(AmiCenterGetSnapshotResponse0 valued) {
		    return valued.getProgress();
	    }
    
	    @Override
	    public void setDouble(AmiCenterGetSnapshotResponse0 valued, double value) {
    ...
    private static final class VALUED_PARAM_CLASS_snapshot extends AbstractValuedParam<AmiCenterGetSnapshotResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    public void write(AmiCenterGetSnapshotResponse0 valued, DataOutput stream) throws IOException{
		       ...
		       throw new IOException("can not write to type to dataStream: com.f1.ami.amicommon.msg.AmiCenterChanges}");
	    ...
	    @Override
	    public Object getValue(AmiCenterGetSnapshotResponse0 valued) {
		    return (com.f1.ami.amicommon.msg.AmiCenterChanges)((AmiCenterGetSnapshotResponse0)valued).getSnapshot();
	    }
    
	    @Override
	    public void setValue(AmiCenterGetSnapshotResponse0 valued, Object value) {
		    valued.setSnapshot((com.f1.ami.amicommon.msg.AmiCenterChanges)value);
	    }
	    ...
	    @Override
	    public boolean areEqual(AmiCenterGetSnapshotResponse0 source, AmiCenterGetSnapshotResponse0 dest) {
	        return OH.eq(dest.getSnapshot(),source.getSnapshot());
	    }
	    ...
	    @Override
	    public Class getReturnType() {
		    return com.f1.ami.amicommon.msg.AmiCenterChanges.class;
	    }
	    private static final Caster CASTER=OH.getCaster(com.f1.ami.amicommon.msg.AmiCenterChanges.class);
	    @Override
	    public Caster getCaster() {
		    return CASTER;
	    }
	    ...
	    @Override
	    public String toString(){
	        return "ValuedParam:com.f1.ami.amicommon.msg.AmiCenterChanges snapshot";
	    }
	    @Override
	    public void clear(AmiCenterGetSnapshotResponse0 valued){
	       valued.setSnapshot(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_snapshot=new VALUED_PARAM_CLASS_snapshot();
  

  
    private static final class VALUED_PARAM_CLASS_ticket extends AbstractValuedParam<AmiCenterGetSnapshotResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterGetSnapshotResponse0 valued) {
		    return (java.lang.String)((AmiCenterGetSnapshotResponse0)valued).getTicket();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_trackedEvents extends AbstractValuedParam<AmiCenterGetSnapshotResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterGetSnapshotResponse0 valued) {
		    return (java.util.List)((AmiCenterGetSnapshotResponse0)valued).getTrackedEvents();
	    }
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_exception, VALUED_PARAM_message, VALUED_PARAM_ok, VALUED_PARAM_priority, VALUED_PARAM_processUid, VALUED_PARAM_progress, VALUED_PARAM_snapshot, VALUED_PARAM_ticket, VALUED_PARAM_trackedEvents, };



    private static final byte PIDS[]={ 44 ,43,42,57,4,53,1,55,58};
    ...
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             ...
             case 4: return VALUED_PARAM_processUid;
             case 53: return VALUED_PARAM_progress;
             case 1: return VALUED_PARAM_snapshot;
    ...
    public byte askPid(String name){
             ...
             if(name=="processUid") return 4;
             if(name=="progress") return 53;
             if(name=="snapshot") return 1;
             ...
             if("processUid".equals(name)) return 4;
             if("progress".equals(name)) return 53;
             if("snapshot".equals(name)) return 1;
    ...
    public Object ask(byte pid){
        switch(pid){
             ...
             case 4: return  this._processUid; 
             case 53: return  OH.valueOf(this._progress); 
             case 1: return  this._snapshot; 
    ...
    public Class askClass(byte pid){
        switch(pid){
             ...
             case 1: return com.f1.ami.amicommon.msg.AmiCenterChanges.class;
    ...
    public void put(byte pid,Object value){
        ...
        switch(pid){
             ...
             case 4: this._processUid=(java.lang.String)value;return;
             case 53: this._progress=(java.lang.Double)value;return;
             case 1: this._snapshot=(com.f1.ami.amicommon.msg.AmiCenterChanges)value;return;
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             ...
             case 4: this._processUid=(java.lang.String)value;return true;
             case 53: this._progress=(java.lang.Double)value;return true;
             case 1: this._snapshot=(com.f1.ami.amicommon.msg.AmiCenterChanges)value;return true;
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 1:
            ...
            this._snapshot=(com.f1.ami.amicommon.msg.AmiCenterChanges)converter.read(session);
...
if(this._snapshot!=null && (0 & transience)==0){
    out.writeByte(1);
        
    converter.write(this._snapshot,session);
