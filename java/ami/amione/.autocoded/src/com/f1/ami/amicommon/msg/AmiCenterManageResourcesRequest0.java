...
public abstract class AmiCenterManageResourcesRequest0 implements com.f1.ami.amicommon.msg.AmiCenterManageResourcesRequest ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private com.f1.ami.amicommon.msg.AmiCenterResource _resource;

    private static final String NAMES[]={ "comment" ,"invokedBy","priority","requestTime","resource"};
    ...
    public void put(String name, Object value){//asdf
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "resource" || name.equals("resource")) {this._resource=(com.f1.ami.amicommon.msg.AmiCenterResource)value;return;}
break;
                case 2:
    ...
    public boolean putNoThrow(String name, Object value){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "resource" || name.equals("resource")) {this._resource=(com.f1.ami.amicommon.msg.AmiCenterResource)value;return true;}
break;
                case 2:
    ...
    public Object ask(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "resource" || name.equals("resource")) {return this._resource;}
    ...
    public Class askClass(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "resource" || name.equals("resource")) {return com.f1.ami.amicommon.msg.AmiCenterResource.class;}
break;
                case 2:
    ...
    public ValuedParam askValuedParam(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "resource" || name.equals("resource")) {return VALUED_PARAM_resource;}
break;
                case 2:
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "resource" || name.equals("resource")) {return 4;}
break;
                case 2:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterManageResourcesRequest0.class;
	}
    ...
    public boolean askParamValid(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "resource" || name.equals("resource")) {return true;}
break;
                case 2:
    ...
    public byte askBasicType(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "resource" || name.equals("resource")) {return 41;}
break;
                case 2:
...
break;
    ...
    public com.f1.ami.amicommon.msg.AmiCenterResource getResource(){
        return this._resource;
    }
    public void setResource(com.f1.ami.amicommon.msg.AmiCenterResource _resource){
    ...
    private static final class VALUED_PARAM_CLASS_comment extends AbstractValuedParam<AmiCenterManageResourcesRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterManageResourcesRequest0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterManageResourcesRequest0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterManageResourcesRequest0 valued) {
		    return (java.lang.String)((AmiCenterManageResourcesRequest0)valued).getComment();
	    }
    
	    @Override
	    public void setValue(AmiCenterManageResourcesRequest0 valued, Object value) {
		    valued.setComment((java.lang.String)value);
	    }
    
	    @Override
	    public void copy(AmiCenterManageResourcesRequest0 source, AmiCenterManageResourcesRequest0 dest) {
		    dest.setComment(source.getComment());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterManageResourcesRequest0 source, AmiCenterManageResourcesRequest0 dest) {
	    ...
	    @Override
	    public void append(AmiCenterManageResourcesRequest0 valued, StringBuilder sb){
	        
	           SH.quote('"',valued.getComment(),sb);
	        
	    }
	    @Override
	    public void append(AmiCenterManageResourcesRequest0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiCenterManageResourcesRequest0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_invokedBy extends AbstractValuedParam<AmiCenterManageResourcesRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageResourcesRequest0 valued) {
		    return (java.lang.String)((AmiCenterManageResourcesRequest0)valued).getInvokedBy();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiCenterManageResourcesRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageResourcesRequest0 valued) {
		    return (int)((AmiCenterManageResourcesRequest0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiCenterManageResourcesRequest0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiCenterManageResourcesRequest0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_requestTime extends AbstractValuedParam<AmiCenterManageResourcesRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageResourcesRequest0 valued) {
		    return (long)((AmiCenterManageResourcesRequest0)valued).getRequestTime();
	    }
	    ...
	    @Override
	    public long getLong(AmiCenterManageResourcesRequest0 valued) {
		    return valued.getRequestTime();
	    }
    
	    @Override
	    public void setLong(AmiCenterManageResourcesRequest0 valued, long value) {
    ...
    private static final class VALUED_PARAM_CLASS_resource extends AbstractValuedParam<AmiCenterManageResourcesRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    public void write(AmiCenterManageResourcesRequest0 valued, DataOutput stream) throws IOException{
		       ...
		       throw new IOException("can not write to type to dataStream: com.f1.ami.amicommon.msg.AmiCenterResource}");
	    ...
	    @Override
	    public Object getValue(AmiCenterManageResourcesRequest0 valued) {
		    return (com.f1.ami.amicommon.msg.AmiCenterResource)((AmiCenterManageResourcesRequest0)valued).getResource();
	    }
    
	    @Override
	    public void setValue(AmiCenterManageResourcesRequest0 valued, Object value) {
		    valued.setResource((com.f1.ami.amicommon.msg.AmiCenterResource)value);
	    }
	    ...
	    @Override
	    public boolean areEqual(AmiCenterManageResourcesRequest0 source, AmiCenterManageResourcesRequest0 dest) {
	        return OH.eq(dest.getResource(),source.getResource());
	    }
	    ...
	    @Override
	    public Class getReturnType() {
		    return com.f1.ami.amicommon.msg.AmiCenterResource.class;
	    }
	    private static final Caster CASTER=OH.getCaster(com.f1.ami.amicommon.msg.AmiCenterResource.class);
	    @Override
	    public Caster getCaster() {
		    return CASTER;
	    }
	    ...
	    @Override
	    public String toString(){
	        return "ValuedParam:com.f1.ami.amicommon.msg.AmiCenterResource resource";
	    }
	    @Override
	    public void clear(AmiCenterManageResourcesRequest0 valued){
	       valued.setResource(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_resource=new VALUED_PARAM_CLASS_resource();
  


    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_comment, VALUED_PARAM_invokedBy, VALUED_PARAM_priority, VALUED_PARAM_requestTime, VALUED_PARAM_resource, };



    private static final byte PIDS[]={ 52 ,51,53,54,1};
    ...
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             ...
             case 1: return VALUED_PARAM_resource;
    ...
    public byte askPid(String name){
             ...
             if("resource".equals(name)) return 1;
            throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public Class askClass(byte pid){
        switch(pid){
             ...
             case 1: return com.f1.ami.amicommon.msg.AmiCenterResource.class;
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid").set("class",askSchema().askOriginalType().getName());
        }
    }
    ...
    public void put(byte pid,Object value){
        ...
        switch(pid){
             ...
             case 1: this._resource=(com.f1.ami.amicommon.msg.AmiCenterResource)value;return;
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid").set("class",askSchema().askOriginalType().getName());
        }
        }catch(NullPointerException e){
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             ...
             case 1: this._resource=(com.f1.ami.amicommon.msg.AmiCenterResource)value;return true;
            default:return false;
        }
    }
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 1:
            ...
            this._resource=(com.f1.ami.amicommon.msg.AmiCenterResource)converter.read(session);
...
if(this._resource!=null && (0 & transience)==0){
    out.writeByte(1);
        
    converter.write(this._resource,session);
