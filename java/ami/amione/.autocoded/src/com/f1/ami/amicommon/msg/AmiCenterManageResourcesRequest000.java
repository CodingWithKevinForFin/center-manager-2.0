...
public  class AmiCenterManageResourcesRequest000 extends com.f1.ami.amicommon.msg.AmiCenterManageResourcesRequest00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public boolean askExistsResource(){
	...
	public AmiCenterManageResourcesRequest000 nw(){
	    return new AmiCenterManageResourcesRequest000();
	}

	public AmiCenterManageResourcesRequest000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterManageResourcesRequest000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    converter.write(this.getResource(),session);
        ...
        for(;;){
            ...
            switch(pid){
                ...
                case 1:
                    ...
                    this.setResource((com.f1.ami.amicommon.msg.AmiCenterResource)converter.read(session));
