...
public abstract class AmiRelayOnConnectRequest0 implements com.f1.ami.amicommon.msg.AmiRelayOnConnectRequest ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiRelayOnConnectRequest0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_centerId extends AbstractValuedParam<AmiRelayOnConnectRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiRelayOnConnectRequest0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiRelayOnConnectRequest0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiRelayOnConnectRequest0 valued) {
		    return (byte)((AmiRelayOnConnectRequest0)valued).getCenterId();
	    }
    
	    @Override
	    public void setValue(AmiRelayOnConnectRequest0 valued, Object value) {
		    valued.setCenterId((java.lang.Byte)value);
	    }
    
	    @Override
	    public void copy(AmiRelayOnConnectRequest0 source, AmiRelayOnConnectRequest0 dest) {
		    dest.setCenterId(source.getCenterId());
	    }
	    
	    @Override
	    public boolean areEqual(AmiRelayOnConnectRequest0 source, AmiRelayOnConnectRequest0 dest) {
	    ...
	    @Override
	    public byte getByte(AmiRelayOnConnectRequest0 valued) {
		    return valued.getCenterId();
	    }
    
	    @Override
	    public void setByte(AmiRelayOnConnectRequest0 valued, byte value) {
	    ...
	    @Override
	    public void append(AmiRelayOnConnectRequest0 valued, StringBuilder sb){
	        
	        sb.append(valued.getCenterId());
	        
	    }
	    @Override
	    public void append(AmiRelayOnConnectRequest0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiRelayOnConnectRequest0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_invokedBy extends AbstractValuedParam<AmiRelayOnConnectRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayOnConnectRequest0 valued) {
		    return (java.lang.String)((AmiRelayOnConnectRequest0)valued).getInvokedBy();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_targetAgentProcessUid extends AbstractValuedParam<AmiRelayOnConnectRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayOnConnectRequest0 valued) {
		    return (java.lang.String)((AmiRelayOnConnectRequest0)valued).getTargetAgentProcessUid();
	    }
