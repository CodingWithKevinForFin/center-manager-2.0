...
public  class AmiRelaySendEmailResponse000 extends com.f1.ami.amicommon.msg.AmiRelaySendEmailResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiRelaySendEmailResponse000 nw(){
	    return new AmiRelaySendEmailResponse000();
	}

	public AmiRelaySendEmailResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiRelaySendEmailResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
