...
public abstract class AmiCenterManageAmiDataRequest0 implements com.f1.ami.amicommon.msg.AmiCenterManageAmiDataRequest ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "action" ,"comment","invokedBy","priority","requestTime"};
...
break;
                case 8:
                    ...
                    if(name == "action" || name.equals("action")) {this._action=(java.lang.Byte)value;return;}
break;
                case 9:
...
break;
                case 8:
                    ...
                    if(name == "action" || name.equals("action")) {this._action=(java.lang.Byte)value;return true;}
break;
                case 9:
...
break;
                case 8:
                    ...
                    if(name == "action" || name.equals("action")) {return byte.class;}
break;
                case 9:
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 2:
                    ...
                    if(name == "requestTime" || name.equals("requestTime")) {return 4;}
break;
                case 4:
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterManageAmiDataRequest0.class;
	}
...
break;
                case 8:
                    ...
                    if(name == "action" || name.equals("action")) {return 1;}
break;
                case 9:
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_action extends AbstractValuedParam<AmiCenterManageAmiDataRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterManageAmiDataRequest0 valued, DataOutput stream) throws IOException{
		    
		      stream.writeByte(valued.getAction());
		    
	    }
	    
	    @Override
	    public void read(AmiCenterManageAmiDataRequest0 valued, DataInput stream) throws IOException{
		    
		      valued.setAction(stream.readByte());
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataRequest0 valued) {
		    return (byte)((AmiCenterManageAmiDataRequest0)valued).getAction();
	    }
    
	    @Override
	    public void setValue(AmiCenterManageAmiDataRequest0 valued, Object value) {
		    valued.setAction((java.lang.Byte)value);
	    }
    
	    @Override
	    public void copy(AmiCenterManageAmiDataRequest0 source, AmiCenterManageAmiDataRequest0 dest) {
		    dest.setAction(source.getAction());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterManageAmiDataRequest0 source, AmiCenterManageAmiDataRequest0 dest) {
	    ...
	    @Override
	    public byte getByte(AmiCenterManageAmiDataRequest0 valued) {
		    return valued.getAction();
	    }
    
	    @Override
	    public void setByte(AmiCenterManageAmiDataRequest0 valued, byte value) {
	    ...
	    @Override
	    public void append(AmiCenterManageAmiDataRequest0 valued, StringBuilder sb){
	        
	        sb.append(valued.getAction());
	        
	    }
	    @Override
	    public void append(AmiCenterManageAmiDataRequest0 valued, StringBuildable sb){
	    ...
	    public String toString(){
	        return "ValuedParam:byte action";
	    }
	    @Override
	    public void clear(AmiCenterManageAmiDataRequest0 valued){
	       valued.setAction((byte)0);
	    }
	};
    ...
    private static final class VALUED_PARAM_CLASS_comment extends AbstractValuedParam<AmiCenterManageAmiDataRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataRequest0 valued) {
		    return (java.lang.String)((AmiCenterManageAmiDataRequest0)valued).getComment();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_invokedBy extends AbstractValuedParam<AmiCenterManageAmiDataRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataRequest0 valued) {
		    return (java.lang.String)((AmiCenterManageAmiDataRequest0)valued).getInvokedBy();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_priority extends AbstractValuedParam<AmiCenterManageAmiDataRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataRequest0 valued) {
		    return (int)((AmiCenterManageAmiDataRequest0)valued).getPriority();
	    }
	    ...
	    @Override
	    public int getInt(AmiCenterManageAmiDataRequest0 valued) {
		    return valued.getPriority();
	    }
    
	    @Override
	    public void setInt(AmiCenterManageAmiDataRequest0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_requestTime extends AbstractValuedParam<AmiCenterManageAmiDataRequest0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterManageAmiDataRequest0 valued) {
		    return (long)((AmiCenterManageAmiDataRequest0)valued).getRequestTime();
	    }
	    ...
	    @Override
	    public long getLong(AmiCenterManageAmiDataRequest0 valued) {
		    return valued.getRequestTime();
	    }
    
	    @Override
	    public void setLong(AmiCenterManageAmiDataRequest0 valued, long value) {
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_action, VALUED_PARAM_comment, VALUED_PARAM_invokedBy, VALUED_PARAM_priority, VALUED_PARAM_requestTime, };



    private static final byte PIDS[]={ 1 ,52,51,53,54};
    
    @Override
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             case 1: return VALUED_PARAM_action;
    ...
    public byte askPid(String name){
             ...
             if("action".equals(name)) return 1;
    ...
    public Object ask(byte pid){
        switch(pid){
             case 1: return  OH.valueOf(this._action); 
    ...
    public void put(byte pid,Object value){
        try{
        switch(pid){
             case 1: this._action=(java.lang.Byte)value;return;
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             case 1: this._action=(java.lang.Byte)value;return true;
    ...
    public void putByte(byte pid,byte value){
        ...
        switch(pid){
             case 1: this._action=value;return;
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid for byte value").set("class",askSchema().askOriginalType().getName());
        }
    }
...
if(this._action!=(byte)0 && (0 & transience)==0){
    out.writeByte(1);
        
    out.writeByte(1);
    out.writeByte(this._action);
