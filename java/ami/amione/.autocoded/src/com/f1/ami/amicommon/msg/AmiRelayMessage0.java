...
public abstract class AmiRelayMessage0 implements com.f1.ami.amicommon.msg.AmiRelayMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiRelayMessage0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_appIdStringKey extends AbstractValuedParam<AmiRelayMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiRelayMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiRelayMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiRelayMessage0 valued) {
		    return (short)((AmiRelayMessage0)valued).getAppIdStringKey();
	    }
    
	    @Override
	    public void setValue(AmiRelayMessage0 valued, Object value) {
		    valued.setAppIdStringKey((java.lang.Short)value);
	    }
    
	    @Override
	    public void copy(AmiRelayMessage0 source, AmiRelayMessage0 dest) {
		    dest.setAppIdStringKey(source.getAppIdStringKey());
	    }
	    
	    @Override
	    public boolean areEqual(AmiRelayMessage0 source, AmiRelayMessage0 dest) {
	    ...
	    @Override
	    public short getShort(AmiRelayMessage0 valued) {
		    return valued.getAppIdStringKey();
	    }
    
	    @Override
	    public void setShort(AmiRelayMessage0 valued, short value) {
	    ...
	    @Override
	    public void append(AmiRelayMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getAppIdStringKey());
	        
	    }
	    @Override
	    public void append(AmiRelayMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiRelayMessage0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_connectionId extends AbstractValuedParam<AmiRelayMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayMessage0 valued) {
		    return (int)((AmiRelayMessage0)valued).getConnectionId();
	    }
	    ...
	    @Override
	    public int getInt(AmiRelayMessage0 valued) {
		    return valued.getConnectionId();
	    }
    
	    @Override
	    public void setInt(AmiRelayMessage0 valued, int value) {
    ...
    private static final class VALUED_PARAM_CLASS_origSeqNum extends AbstractValuedParam<AmiRelayMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayMessage0 valued) {
		    return (long)((AmiRelayMessage0)valued).getOrigSeqNum();
	    }
	    ...
	    @Override
	    public long getLong(AmiRelayMessage0 valued) {
		    return valued.getOrigSeqNum();
	    }
    
	    @Override
	    public void setLong(AmiRelayMessage0 valued, long value) {
    ...
    private static final class VALUED_PARAM_CLASS_params extends AbstractValuedParam<AmiRelayMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayMessage0 valued) {
		    return (byte[])((AmiRelayMessage0)valued).getParams();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_transformState extends AbstractValuedParam<AmiRelayMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayMessage0 valued) {
		    return (byte)((AmiRelayMessage0)valued).getTransformState();
	    }
	    ...
	    @Override
	    public byte getByte(AmiRelayMessage0 valued) {
		    return valued.getTransformState();
	    }
    
	    @Override
	    public void setByte(AmiRelayMessage0 valued, byte value) {
