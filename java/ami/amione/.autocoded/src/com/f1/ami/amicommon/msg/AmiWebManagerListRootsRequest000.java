...
public  class AmiWebManagerListRootsRequest000 extends com.f1.ami.amicommon.msg.AmiWebManagerListRootsRequest00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiWebManagerListRootsRequest000 nw(){
	    return new AmiWebManagerListRootsRequest000();
	}

	public AmiWebManagerListRootsRequest000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiWebManagerListRootsRequest000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
