...
public  class AmiRelayOnConnectRequest000 extends com.f1.ami.amicommon.msg.AmiRelayOnConnectRequest00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiRelayOnConnectRequest000 nw(){
	    return new AmiRelayOnConnectRequest000();
	}

	public AmiRelayOnConnectRequest000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiRelayOnConnectRequest000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
