...
public  class AmiCenterGetSnapshotRequest000 extends com.f1.ami.amicommon.msg.AmiCenterGetSnapshotRequest00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
    ...
    public void setAmiObjectTypesToSend(java.util.Set _amiObjectTypesToSend){
	    super.setAmiObjectTypesToSend(_amiObjectTypesToSend);
	    existing.set(0,true);
    }
    public boolean askExistsAmiObjectTypesToSend(){
    ...
    public void setIncludeStringPool(boolean _includeStringPool){
	    super.setIncludeStringPool(_includeStringPool);
	    existing.set(2,true);
    }
    public boolean askExistsIncludeStringPool(){
    ...
    public void setMaxBatchSize(int _maxBatchSize){
	    super.setMaxBatchSize(_maxBatchSize);
	    existing.set(4,true);
    }
    public boolean askExistsMaxBatchSize(){
    ...
    public void setSupportsIntermediate(boolean _supportsIntermediate){
	    super.setSupportsIntermediate(_supportsIntermediate);
	    existing.set(7,true);
    }
    public boolean askExistsSupportsIntermediate(){
	...
	public AmiCenterGetSnapshotRequest000 nw(){
	    return new AmiCenterGetSnapshotRequest000();
	}

	public AmiCenterGetSnapshotRequest000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterGetSnapshotRequest000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
    ...
    out.writeByte(0);
    out.writeBoolean(this.getSupportsIntermediate());
    ...
    out.writeByte(4);
    out.writeInt(this.getMaxBatchSize());
    ...
    converter.write(this.getAmiObjectTypesToSend(),session);
    ...
    out.writeByte(0);
    out.writeBoolean(this.getIncludeStringPool());
            ...
            switch(pid){
                ...
                case 1:
                    ...
                    if((basicType=in.readByte())!=0)
                        break;
                    this.setSupportsIntermediate(in.readBoolean());
                ...
                case 2:
                    ...
                    if((basicType=in.readByte())!=4)
                        break;
                    this.setMaxBatchSize(in.readInt());
        
                    continue;
  
                case 3:
        
                    this.setAmiObjectTypesToSend((java.util.Set)converter.read(session));
                ...
                case 4:
                    ...
                    if((basicType=in.readByte())!=0)
                        break;
                    this.setIncludeStringPool(in.readBoolean());
