...
public abstract class AmiCenterClientObjectMessages0 implements com.f1.ami.amicommon.centerclient.AmiCenterClientObjectMessages ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,Cloneable{
    ...
    private static final String NAMES[]={ "centerId" ,"messages","seqNum"};
...
break;
                case 4:
                    ...
                    if(name == "messages" || name.equals("messages")) {this._messages=(java.util.List)value;return;}
break;
        }
...
break;
                case 4:
                    ...
                    if(name == "messages" || name.equals("messages")) {this._messages=(java.util.List)value;return true;}
break;
        }
        return false;
    }
...
break;
                case 4:
                    ...
                    if(name == "messages" || name.equals("messages")) {return this._messages;}
...
break;
                case 4:
                    ...
                    if(name == "messages" || name.equals("messages")) {return java.util.List.class;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
...
break;
                case 4:
                    ...
                    if(name == "messages" || name.equals("messages")) {return VALUED_PARAM_messages;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
...
break;
                case 4:
                    ...
                    if(name == "messages" || name.equals("messages")) {return 1;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
	...
	public Class<Valued> askType(){
	    return (Class)AmiCenterClientObjectMessages0.class;
	}
...
break;
                case 4:
                    ...
                    if(name == "messages" || name.equals("messages")) {return true;}
break;
        }
        return false;
    }
...
break;
                case 4:
                    ...
                    if(name == "messages" || name.equals("messages")) {return 21;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public void setMessages(java.util.List _messages){
    ...
    private static final class VALUED_PARAM_CLASS_centerId extends AbstractValuedParam<AmiCenterClientObjectMessages0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiCenterClientObjectMessages0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiCenterClientObjectMessages0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiCenterClientObjectMessages0 valued) {
		    return (byte)((AmiCenterClientObjectMessages0)valued).getCenterId();
	    }
    
	    @Override
	    public void setValue(AmiCenterClientObjectMessages0 valued, Object value) {
		    valued.setCenterId((java.lang.Byte)value);
	    }
    
	    @Override
	    public void copy(AmiCenterClientObjectMessages0 source, AmiCenterClientObjectMessages0 dest) {
		    dest.setCenterId(source.getCenterId());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterClientObjectMessages0 source, AmiCenterClientObjectMessages0 dest) {
	    ...
	    @Override
	    public byte getByte(AmiCenterClientObjectMessages0 valued) {
		    return valued.getCenterId();
	    }
    
	    @Override
	    public void setByte(AmiCenterClientObjectMessages0 valued, byte value) {
	    ...
	    @Override
	    public void append(AmiCenterClientObjectMessages0 valued, StringBuilder sb){
	        
	        sb.append(valued.getCenterId());
	        
	    }
	    @Override
	    public void append(AmiCenterClientObjectMessages0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiCenterClientObjectMessages0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_messages extends AbstractValuedParam<AmiCenterClientObjectMessages0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterClientObjectMessages0 valued) {
		    return (java.util.List)((AmiCenterClientObjectMessages0)valued).getMessages();
	    }
    
	    @Override
	    public void setValue(AmiCenterClientObjectMessages0 valued, Object value) {
		    valued.setMessages((java.util.List)value);
	    }
    
	    @Override
	    public void copy(AmiCenterClientObjectMessages0 source, AmiCenterClientObjectMessages0 dest) {
		    dest.setMessages(source.getMessages());
	    }
	    
	    @Override
	    public boolean areEqual(AmiCenterClientObjectMessages0 source, AmiCenterClientObjectMessages0 dest) {
	        return OH.eq(dest.getMessages(),source.getMessages());
	    }
	    ...
	    @Override
	    public String toString(){
	        return "ValuedParam:java.util.List messages";
	    }
	    @Override
	    public void clear(AmiCenterClientObjectMessages0 valued){
	       valued.setMessages(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_messages=new VALUED_PARAM_CLASS_messages();
  

  
    private static final class VALUED_PARAM_CLASS_seqNum extends AbstractValuedParam<AmiCenterClientObjectMessages0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiCenterClientObjectMessages0 valued) {
		    return (long)((AmiCenterClientObjectMessages0)valued).getSeqNum();
	    }
	    ...
	    @Override
	    public long getLong(AmiCenterClientObjectMessages0 valued) {
		    return valued.getSeqNum();
	    }
    
	    @Override
	    public void setLong(AmiCenterClientObjectMessages0 valued, long value) {
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_centerId, VALUED_PARAM_messages, VALUED_PARAM_seqNum, };
