...
public  class AmiRelayResponse000 extends com.f1.ami.amicommon.msg.AmiRelayResponse00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiRelayResponse000 nw(){
	    return new AmiRelayResponse000();
	}

	public AmiRelayResponse000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiRelayResponse000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
