...
public  class AmiCenterManageAmiDataRequest000 extends com.f1.ami.amicommon.msg.AmiCenterManageAmiDataRequest00 implements Iterable<ValuedParam>,ByteArraySelfConverter{
	...
	public AmiCenterManageAmiDataRequest000 nw(){
	    return new AmiCenterManageAmiDataRequest000();
	}

	public AmiCenterManageAmiDataRequest000 nw(Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}

	public AmiCenterManageAmiDataRequest000 nwCast(Class[] types, Object[] args){
	    if(args==null || args.length==0)
	        return nw();
	    throw new UnsupportedOperationException("ONLY DEFAULT CONSTRUCTOR SUPPORTED");
	}
