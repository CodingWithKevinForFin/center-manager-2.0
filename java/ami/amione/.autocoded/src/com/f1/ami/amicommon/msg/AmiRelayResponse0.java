...
public abstract class AmiRelayResponse0 implements com.f1.ami.amicommon.msg.AmiRelayResponse ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)AmiRelayResponse0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_exception extends AbstractValuedParam<AmiRelayResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(AmiRelayResponse0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(AmiRelayResponse0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(AmiRelayResponse0 valued) {
		    return (java.lang.Exception)((AmiRelayResponse0)valued).getException();
	    }
    
	    @Override
	    public void setValue(AmiRelayResponse0 valued, Object value) {
		    valued.setException((java.lang.Exception)value);
	    }
    
	    @Override
	    public void copy(AmiRelayResponse0 source, AmiRelayResponse0 dest) {
		    dest.setException(source.getException());
	    }
	    
	    @Override
	    public boolean areEqual(AmiRelayResponse0 source, AmiRelayResponse0 dest) {
	    ...
	    @Override
	    public void append(AmiRelayResponse0 valued, StringBuilder sb){
	        
	        sb.append(valued.getException());
	        
	    }
	    @Override
	    public void append(AmiRelayResponse0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(AmiRelayResponse0 valued){
    ...
    private static final class VALUED_PARAM_CLASS_message extends AbstractValuedParam<AmiRelayResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayResponse0 valued) {
		    return (java.lang.String)((AmiRelayResponse0)valued).getMessage();
	    }
    ...
    private static final class VALUED_PARAM_CLASS_ok extends AbstractValuedParam<AmiRelayResponse0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public Object getValue(AmiRelayResponse0 valued) {
		    return (boolean)((AmiRelayResponse0)valued).getOk();
	    }
	    ...
	    @Override
	    public boolean getBoolean(AmiRelayResponse0 valued) {
		    return valued.getOk();
	    }
    
	    @Override
	    public void setBoolean(AmiRelayResponse0 valued, boolean value) {
		    valued.setOk(value);
	    }
