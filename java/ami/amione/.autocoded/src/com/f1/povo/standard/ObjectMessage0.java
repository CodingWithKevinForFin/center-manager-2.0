...
public abstract class ObjectMessage0 implements com.f1.povo.standard.ObjectMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "object" };
    ...
    public void put(String name, Object value){//asdf
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "object" || name.equals("object")) {this._object=(java.lang.Object)value;return;}
break;
        }
    ...
    public boolean putNoThrow(String name, Object value){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "object" || name.equals("object")) {this._object=(java.lang.Object)value;return true;}
break;
        }
        return false;
    }
    ...
    public Object ask(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "object" || name.equals("object")) {return this._object;}
    ...
    public Class askClass(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "object" || name.equals("object")) {return java.lang.Object.class;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public ValuedParam askValuedParam(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "object" || name.equals("object")) {return VALUED_PARAM_object;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "object" || name.equals("object")) {return 0;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
	...
	public Class<Valued> askType(){
	    return (Class)ObjectMessage0.class;
	}
    ...
    public boolean askParamValid(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "object" || name.equals("object")) {return true;}
break;
        }
        return false;
    }
    ...
    public byte askBasicType(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "object" || name.equals("object")) {return 18;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    private static final class VALUED_PARAM_CLASS_object extends AbstractValuedParam<ObjectMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(ObjectMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(ObjectMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(ObjectMessage0 valued) {
		    return (java.lang.Object)((ObjectMessage0)valued).getObject();
	    }
    
	    @Override
	    public void setValue(ObjectMessage0 valued, Object value) {
		    valued.setObject((java.lang.Object)value);
	    }
    
	    @Override
	    public void copy(ObjectMessage0 source, ObjectMessage0 dest) {
		    dest.setObject(source.getObject());
	    }
	    
	    @Override
	    public boolean areEqual(ObjectMessage0 source, ObjectMessage0 dest) {
	        return OH.eq(dest.getObject(),source.getObject());
	    }
	    ...
	    @Override
	    public void append(ObjectMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getObject());
	        
	    }
	    @Override
	    public void append(ObjectMessage0 valued, StringBuildable sb){
	    ...
	    public String toString(){
	        return "ValuedParam:java.lang.Object object";
	    }
	    @Override
	    public void clear(ObjectMessage0 valued){
	       valued.setObject(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_object=new VALUED_PARAM_CLASS_object();
  


    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_object, };
    ...
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             case 1: return VALUED_PARAM_object;
    ...
    public byte askPid(String name){
             ...
             if("object".equals(name)) return 1;
            throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public void put(byte pid,Object value){
        try{
        switch(pid){
             case 1: this._object=(java.lang.Object)value;return;
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid").set("class",askSchema().askOriginalType().getName());
        }
        }catch(NullPointerException e){
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             case 1: this._object=(java.lang.Object)value;return true;
            default:return false;
        }
    }
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 1:
            ...
            this._object=(java.lang.Object)converter.read(session);
...
if(this._object!=null && (0 & transience)==0){
    out.writeByte(1);
        
    converter.write(this._object,session);
