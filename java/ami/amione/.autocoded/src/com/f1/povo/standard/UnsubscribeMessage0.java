...
public abstract class UnsubscribeMessage0 implements com.f1.povo.standard.UnsubscribeMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)UnsubscribeMessage0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_partitionId extends AbstractValuedParam<UnsubscribeMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(UnsubscribeMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(UnsubscribeMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(UnsubscribeMessage0 valued) {
		    return (java.lang.Object)((UnsubscribeMessage0)valued).getPartitionId();
	    }
    
	    @Override
	    public void setValue(UnsubscribeMessage0 valued, Object value) {
		    valued.setPartitionId((java.lang.Object)value);
	    }
    
	    @Override
	    public void copy(UnsubscribeMessage0 source, UnsubscribeMessage0 dest) {
		    dest.setPartitionId(source.getPartitionId());
	    }
	    
	    @Override
	    public boolean areEqual(UnsubscribeMessage0 source, UnsubscribeMessage0 dest) {
	    ...
	    @Override
	    public void append(UnsubscribeMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getPartitionId());
	        
	    }
	    @Override
	    public void append(UnsubscribeMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(UnsubscribeMessage0 valued){
