...
public abstract class TextMessage0 implements com.f1.povo.standard.TextMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "text" };
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "text" || name.equals("text")) {return 0;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
	...
	public Class<Valued> askType(){
	    return (Class)TextMessage0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_text extends AbstractValuedParam<TextMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(TextMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(TextMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(TextMessage0 valued) {
		    return (java.lang.String)((TextMessage0)valued).getText();
	    }
    
	    @Override
	    public void setValue(TextMessage0 valued, Object value) {
		    valued.setText((java.lang.String)value);
	    }
    
	    @Override
	    public void copy(TextMessage0 source, TextMessage0 dest) {
		    dest.setText(source.getText());
	    }
	    
	    @Override
	    public boolean areEqual(TextMessage0 source, TextMessage0 dest) {
	    ...
	    @Override
	    public void append(TextMessage0 valued, StringBuilder sb){
	        
	           SH.quote('"',valued.getText(),sb);
	        
	    }
	    @Override
	    public void append(TextMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(TextMessage0 valued){
	       valued.setText(null);
	    }
	};
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_text, };
