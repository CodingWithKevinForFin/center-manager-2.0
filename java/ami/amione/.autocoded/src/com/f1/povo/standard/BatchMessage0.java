...
public abstract class BatchMessage0 implements com.f1.povo.standard.BatchMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "messages" };
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "messages" || name.equals("messages")) {return 0;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
	...
	public Class<Valued> askType(){
	    return (Class)BatchMessage0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_messages extends AbstractValuedParam<BatchMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(BatchMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(BatchMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(BatchMessage0 valued) {
		    return (java.util.List)((BatchMessage0)valued).getMessages();
	    }
    
	    @Override
	    public void setValue(BatchMessage0 valued, Object value) {
		    valued.setMessages((java.util.List)value);
	    }
    
	    @Override
	    public void copy(BatchMessage0 source, BatchMessage0 dest) {
		    dest.setMessages(source.getMessages());
	    }
	    
	    @Override
	    public boolean areEqual(BatchMessage0 source, BatchMessage0 dest) {
	    ...
	    @Override
	    public void append(BatchMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getMessages());
	        
	    }
	    @Override
	    public void append(BatchMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(BatchMessage0 valued){
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_messages, };
    ...
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             case 1: return VALUED_PARAM_messages;
    ...
    public byte askPid(String name){
             if(name=="messages") return 1;
            
             if("messages".equals(name)) return 1;
            throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public void put(byte pid,Object value){
        try{
        switch(pid){
             case 1: this._messages=(java.util.List)value;return;
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid").set("class",askSchema().askOriginalType().getName());
        }
        }catch(NullPointerException e){
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             case 1: this._messages=(java.util.List)value;return true;
            default:return false;
        }
    }
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 1:
            ...
            this._messages=(java.util.List)converter.read(session);
...
if(this._messages!=null && (0 & transience)==0){
    out.writeByte(1);
        
    converter.write(this._messages,session);
