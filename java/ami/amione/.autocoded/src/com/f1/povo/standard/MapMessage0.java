...
public abstract class MapMessage0 implements com.f1.povo.standard.MapMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
    ...
    private static final String NAMES[]={ "map" };
    ...
    public void put(String name, Object value){//asdf
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "map" || name.equals("map")) {this._map=(java.util.Map)value;return;}
break;
        }
    ...
    public boolean putNoThrow(String name, Object value){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "map" || name.equals("map")) {this._map=(java.util.Map)value;return true;}
break;
        }
        return false;
    }
    ...
    public Object ask(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "map" || name.equals("map")) {return this._map;}
    ...
    public Class askClass(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "map" || name.equals("map")) {return java.util.Map.class;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public ValuedParam askValuedParam(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "map" || name.equals("map")) {return VALUED_PARAM_map;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public int askPosition(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "map" || name.equals("map")) {return 0;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
	...
	public Class<Valued> askType(){
	    return (Class)MapMessage0.class;
	}
    ...
    public boolean askParamValid(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "map" || name.equals("map")) {return true;}
break;
        }
        return false;
    }
    ...
    public byte askBasicType(String name){
        ...
        switch(h){
                ...
                case 0:
                    ...
                    if(name == "map" || name.equals("map")) {return 23;}
break;
        }
        throw newMissingValueException(name,NAMES,"no such param name").set("class",askSchema().askOriginalType().getName());
    }
    ...
    public void setMap(java.util.Map _map){
    ...
    private static final class VALUED_PARAM_CLASS_map extends AbstractValuedParam<MapMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(MapMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(MapMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(MapMessage0 valued) {
		    return (java.util.Map)((MapMessage0)valued).getMap();
	    }
    
	    @Override
	    public void setValue(MapMessage0 valued, Object value) {
		    valued.setMap((java.util.Map)value);
	    }
    
	    @Override
	    public void copy(MapMessage0 source, MapMessage0 dest) {
		    dest.setMap(source.getMap());
	    }
	    
	    @Override
	    public boolean areEqual(MapMessage0 source, MapMessage0 dest) {
	        return OH.eq(dest.getMap(),source.getMap());
	    }
	    ...
	    @Override
	    public void append(MapMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getMap());
	        
	    }
	    @Override
	    public void append(MapMessage0 valued, StringBuildable sb){
	    ...
	    public String toString(){
	        return "ValuedParam:java.util.Map map";
	    }
	    @Override
	    public void clear(MapMessage0 valued){
	       valued.setMap(null);
	    }
	};
    private static final ValuedParam VALUED_PARAM_map=new VALUED_PARAM_CLASS_map();
  


    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_map, };
    ...
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             case 1: return VALUED_PARAM_map;
    ...
    public void put(byte pid,Object value){
        try{
        switch(pid){
             case 1: this._map=(java.util.Map)value;return;
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid").set("class",askSchema().askOriginalType().getName());
        }
        }catch(NullPointerException e){
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             case 1: this._map=(java.util.Map)value;return true;
            default:return false;
        }
    }
    ...
    public void read(FromByteArrayConverterSession session) throws IOException{
        ...
        case 1:
            ...
            this._map=(java.util.Map)converter.read(session);
...
if(this._map!=null && (0 & transience)==0){
    out.writeByte(1);
        
    converter.write(this._map,session);
