...
public abstract class CountMessage0 implements com.f1.povo.standard.CountMessage ,  com.f1.base.ValuedSchema, com.f1.base.CodeGenerated ,ByteArraySelfConverter,Cloneable{
...
break;
	...
	public Class<Valued> askType(){
	    return (Class)CountMessage0.class;
	}
...
break;
    ...
    private static final class VALUED_PARAM_CLASS_count extends AbstractValuedParam<CountMessage0> implements  com.f1.base.CodeGenerated {
	    ...
	    @Override
	    public void write(CountMessage0 valued, DataOutput stream) throws IOException{
	    ...
	    @Override
	    public void read(CountMessage0 valued, DataInput stream) throws IOException{
	    ...
	    @Override
	    public Object getValue(CountMessage0 valued) {
		    return (long)((CountMessage0)valued).getCount();
	    }
    
	    @Override
	    public void setValue(CountMessage0 valued, Object value) {
		    valued.setCount((java.lang.Long)value);
	    }
    
	    @Override
	    public void copy(CountMessage0 source, CountMessage0 dest) {
		    dest.setCount(source.getCount());
	    }
	    
	    @Override
	    public boolean areEqual(CountMessage0 source, CountMessage0 dest) {
	    ...
	    @Override
	    public long getLong(CountMessage0 valued) {
		    return valued.getCount();
	    }
    
	    @Override
	    public void setLong(CountMessage0 valued, long value) {
	    ...
	    @Override
	    public void append(CountMessage0 valued, StringBuilder sb){
	        
	        sb.append(valued.getCount());
	        
	    }
	    @Override
	    public void append(CountMessage0 valued, StringBuildable sb){
	    ...
	    @Override
	    public void clear(CountMessage0 valued){
	       valued.setCount(0L);
	    }
	};
    ...
    private static final ValuedParam VALUED_PARAMS[]=new ValuedParam[]{ VALUED_PARAM_count, };
    ...
    public ValuedParam askValuedParam(byte pid){
        switch(pid){
             case 1: return VALUED_PARAM_count;
    ...
    public Object ask(byte pid){
        switch(pid){
             case 1: return  OH.valueOf(this._count); 
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid").set("class",askSchema().askOriginalType().getName());
        }
    }
    ...
    public void put(byte pid,Object value){
        try{
        switch(pid){
             case 1: this._count=(java.lang.Long)value;return;
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid").set("class",askSchema().askOriginalType().getName());
        }
        }catch(NullPointerException e){
    ...
    public boolean putNoThrow(byte pid,Object value){
        switch(pid){
             case 1: this._count=(java.lang.Long)value;return true;
            default:return false;
        }
    }
    ...
    public void putLong(byte pid,long value){
        ...
        switch(pid){
             case 1: this._count=value;return;
            default:throw newMissingValueException(Byte.toString(pid),PIDS,"no such pid for long value").set("class",askSchema().askOriginalType().getName());
        }
    }
