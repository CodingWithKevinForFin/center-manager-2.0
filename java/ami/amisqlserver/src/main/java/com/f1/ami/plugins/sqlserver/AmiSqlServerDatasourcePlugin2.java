...
public class AmiSqlServerDatasourcePlugin2 implements AmiDatasourcePlugin {
	private static final String DATASOURCE_TYPE = "SQLSERVER MSSQL";
	private static final String DATASOURCE_DESC = "SQLServer JDBC MSSQL";
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiSqlServerDatasourceAdapter2();
	}
