...
public class AmiWebFunctionBitXor extends AbstractMethodDerivedCellCalculator2 {
	private static final ParamsDefinition VERIFIER = new ParamsDefinition("bitwiseXor", Number.class, "Number a,Number b");
	static {
		VERIFIER.addDesc("Returns the bitwise XOR of two numbers.");
	...
	public AmiWebFunctionBitXor(int position, DerivedCellCalculator p0, DerivedCellCalculator p1) {
	...
	public Object eval(Object o0, Object o1) {
		if (math == null)
			return null;
		return math.xor((Number) o0, (Number) o1);
	}

	@Override
	public DerivedCellCalculator copy(DerivedCellCalculator p0, DerivedCellCalculator p1) {
		return new AmiWebFunctionBitXor(getPosition(), p0, p1);
	}
	@Override
	...
	public static class Factory implements AmiWebFunctionFactory {
		...
		public DerivedCellCalculator toMethod(int position, String methodName, DerivedCellCalculator[] calcs, com.f1.utils.structs.table.stack.CalcTypesStack context) {
			return new AmiWebFunctionBitXor(position, calcs[0], calcs[1]);
		}
