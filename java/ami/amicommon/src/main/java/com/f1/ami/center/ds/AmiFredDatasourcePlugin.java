...
public class AmiFredDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "FRED";
	private static final String DATASOURCE_DESC = "Fred";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "Your API key from fred.stlouisfed.org", AmiDatasourcePlugin.HELP_GENERAL,
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiFredDatasourceAdapter();
	}
