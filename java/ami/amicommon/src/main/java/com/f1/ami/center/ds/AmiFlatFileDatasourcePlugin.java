...
public class AmiFlatFileDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "FLAT_FILE";
	private static final String DATASOURCE_DESC = "Flat File Reader";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "/path/to/directory/containing/files/", AmiDatasourcePlugin.HELP_GENERAL,
			"flat file general help");

	private static final Map<String, String> OPTIONS_MAP = AmiFlatFileDatasourceAdapter2.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiFlatFileDatasourceAdapter2();
	}
