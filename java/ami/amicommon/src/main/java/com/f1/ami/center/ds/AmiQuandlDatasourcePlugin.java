...
public class AmiQuandlDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "QUANDL";
	private static final String DATASOURCE_DESC = "Quandl";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "Your API key from quandl.com", AmiDatasourcePlugin.HELP_GENERAL,
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiQuandlDatasourceAdapter();
	}
