...
public class AmiWebFunctionRandSec2 extends AbstractMethodDerivedCellCalculator1 {

	private static final Logger log = LH.get();
	private static final ParamsDefinition VERIFIER = new ParamsDefinition("randSec", Number.class, "Number range");
	static {
		VERIFIER.addDesc(
	...
	public AmiWebFunctionRandSec2(int position, DerivedCellCalculator param, Random random) {
	...
	public DerivedCellCalculator copy(DerivedCellCalculator params2) {
		return new AmiWebFunctionRandSec2(getPosition(), params2, random);
	}
	...
	public static class Factory implements AmiWebFunctionFactory {
		...
		public DerivedCellCalculator toMethod(int position, String methodName, DerivedCellCalculator[] calcs, com.f1.utils.structs.table.stack.CalcTypesStack context) {
			return new AmiWebFunctionRandSec2(position, calcs[0], MH.RANDOM_SECURE);
		}
