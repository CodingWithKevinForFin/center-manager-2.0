...
public class AmiWebFunctionStrIsnt extends AbstractMethodDerivedCellCalculator1 {
	private static final ParamsDefinition VERIFIER = new ParamsDefinition("strIsnt", Boolean.class, "String text");
	static {
		VERIFIER.addDesc(
	...
	public AmiWebFunctionStrIsnt(int position, DerivedCellCalculator params) {
	...
	public Object eval(Object value) {
		return value == null || SH.isnt(AmiUtils.s(value));
	}

	@Override
	public DerivedCellCalculator copy(DerivedCellCalculator params2) {
		return new AmiWebFunctionStrIsnt(getPosition(), params2);
	}
	...
	public static class Factory implements AmiWebFunctionFactory {
		...
		public DerivedCellCalculator toMethod(int position, String methodName, DerivedCellCalculator[] calcs, com.f1.utils.structs.table.stack.CalcTypesStack context) {
			return new AmiWebFunctionStrIsnt(position, calcs[0]);
		}
