...
public class AmiWebFunctionParseDate extends AbstractMethodDerivedCellCalculator2 {

	private static final ParamsDefinition VERIFIER = new ParamsDefinition("parseDate", Long.class, "String text,String format");
	static {
		VERIFIER.addDesc("Deprecated, use parseDate(text,format,timezone) instead");
		VERIFIER.addRetDesc("long(current time in milliseconds UTC since unix epoch) or null");
	...
	public AmiWebFunctionParseDate(int position, DerivedCellCalculator p0, DerivedCellCalculator p1) {
	...
	public DerivedCellCalculator copy(DerivedCellCalculator p0, DerivedCellCalculator p1) {
		return new AmiWebFunctionParseDate(getPosition(), p0, p1);
	}
	...
	public static class Factory implements AmiWebFunctionFactory {
		...
		public DerivedCellCalculator toMethod(int position, String methodName, DerivedCellCalculator[] calcs, com.f1.utils.structs.table.stack.CalcTypesStack context) {
			return new AmiWebFunctionParseDate(position, calcs[0], calcs[1]);
		}
