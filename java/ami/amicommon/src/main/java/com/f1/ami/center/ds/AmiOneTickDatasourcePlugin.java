...
public class AmiOneTickDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "ONETICK";
	private static final String DATASOURCE_DESC = "OneTick";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "OneTick Web API, ex: https://cldr.onetick.com:443/omdwebapi/rest/",
			AmiDatasourcePlugin.HELP_GENERAL, "Executed Command general help");

	private static final Map<String, String> OPTIONS_MAP = AmiOneTickDatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiOneTickDatasourceAdapter();
	}
