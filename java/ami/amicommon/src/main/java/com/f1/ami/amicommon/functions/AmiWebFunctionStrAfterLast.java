...
public class AmiWebFunctionStrAfterLast extends AbstractMethodDerivedCellCalculator3 {
	private static final ParamsDefinition VERIFIER = new ParamsDefinition("strAfterLast", String.class, "String text,String toFind,Boolean origIfNotFound");
	static {
		VERIFIER.addDesc(
	...
	public AmiWebFunctionStrAfterLast(int position, DerivedCellCalculator p0, DerivedCellCalculator p1, DerivedCellCalculator p2) {
	...
	public DerivedCellCalculator copy(DerivedCellCalculator p0, DerivedCellCalculator p1, DerivedCellCalculator p2) {
		return new AmiWebFunctionStrAfterLast(getPosition(), p0, p1, p2);
	}
	...
	public static class Factory implements AmiWebFunctionFactory {
		...
		public DerivedCellCalculator toMethod(int position, String methodName, DerivedCellCalculator[] calcs, com.f1.utils.structs.table.stack.CalcTypesStack context) {
			return new AmiWebFunctionStrAfterLast(position, calcs[0], calcs[1], calcs[2]);
		}
