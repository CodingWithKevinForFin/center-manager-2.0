...
public class AmiAmiDbDatasourcePlugin implements AmiDatasourcePlugin {

	public static final String ID = "AMIDB";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "localhost:3280", AmiDatasourcePlugin.HELP_GENERAL, "AmiDb general help");
	private static final Map<String, String> OPTIONS_MAP = AmiAmiDbDatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiAmiDbDatasourceAdapter();
	}
