...
public class AmiWebFunctionRoundNearestDown extends AbstractMethodDerivedCellCalculator2 {

	private static final ParamsDefinition VERIFIER = new ParamsDefinition("roundNearestDown", Number.class, "Number value,Number bucketSize");
	static {
		VERIFIER.addDesc("Given the value and the bucket size, returns a Long that rounds DOWN to the closest multiple of the bucket	size.");
	...
	public AmiWebFunctionRoundNearestDown(int position, DerivedCellCalculator p0, DerivedCellCalculator p1) {
	...
	public Object eval(Object o0, Object o1) {
		...
		if (math.compare(r, v) <= 0)
			return r;
		return math.subtract(r, b);
	}

	@Override
	public DerivedCellCalculator copy(DerivedCellCalculator p0, DerivedCellCalculator p1) {
		return new AmiWebFunctionRoundNearestDown(getPosition(), p0, p1);
	}
	...
	public static class Factory implements AmiWebFunctionFactory {
		...
		public DerivedCellCalculator toMethod(int position, String methodName, DerivedCellCalculator[] calcs, com.f1.utils.structs.table.stack.CalcTypesStack context) {
			return new AmiWebFunctionRoundNearestDown(position, calcs[0], calcs[1]);
		}
