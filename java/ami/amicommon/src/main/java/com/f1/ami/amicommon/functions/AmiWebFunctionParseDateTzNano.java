...
public class AmiWebFunctionParseDateTzNano extends AbstractMethodDerivedCellCalculator3 {

	private static final ParamsDefinition VERIFIER = new ParamsDefinition("parseDateNano", DateNanos.class, "String text,String format,String timezone");
	static {
		VERIFIER.addDesc("Converts a string to a unix epoch time. Returns a UTCN object that represents the given time.");
	...
	public AmiWebFunctionParseDateTzNano(int position, DerivedCellCalculator p0, DerivedCellCalculator p1, DerivedCellCalculator p2) {
	...
	public DerivedCellCalculator copy(DerivedCellCalculator p0, DerivedCellCalculator p1, DerivedCellCalculator p2) {
		return new AmiWebFunctionParseDateTzNano(getPosition(), p0, p1, p2);
	}
	...
	public static class Factory implements AmiWebFunctionFactory {
		...
		public DerivedCellCalculator toMethod(int position, String methodName, DerivedCellCalculator[] calcs, com.f1.utils.structs.table.stack.CalcTypesStack context) {
			return new AmiWebFunctionParseDateTzNano(position, calcs[0], calcs[1], calcs[2]);
		}
