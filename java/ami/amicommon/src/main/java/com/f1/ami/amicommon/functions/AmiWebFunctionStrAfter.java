...
public class AmiWebFunctionStrAfter extends AbstractMethodDerivedCellCalculator3 {
	private static final ParamsDefinition VERIFIER = new ParamsDefinition("strAfter", String.class, "String text,String toFind,Boolean origIfNotFound");
	static {
		VERIFIER.addDesc(
				"Returns the portion of a string after the first occurence of a delimiter. If the delimiter is not found, then return either the original string or null depending on origIfNotFound param.");
	...
	public AmiWebFunctionStrAfter(int position, DerivedCellCalculator p0, DerivedCellCalculator p1, DerivedCellCalculator p2) {
	...
	public Object eval(Object o0, Object o1, Object o2) {
		...
		if (i == -1)
			return Boolean.TRUE.equals(origIfNotFound) ? text : null;
		return text.substring(i + toFind.length());
	}
	...
	public DerivedCellCalculator copy(DerivedCellCalculator p0, DerivedCellCalculator p1, DerivedCellCalculator p2) {
		return new AmiWebFunctionStrAfter(getPosition(), p0, p1, p2);
	}
	...
	public static class Factory implements AmiWebFunctionFactory {
		...
		public DerivedCellCalculator toMethod(int position, String methodName, DerivedCellCalculator[] calcs, com.f1.utils.structs.table.stack.CalcTypesStack context) {
			return new AmiWebFunctionStrAfter(position, calcs[0], calcs[1], calcs[2]);
		}
