...
public class AmiShellDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "SHELL";
	private static final String DATASOURCE_DESC = "Shell Command";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "/path/to/working/directory", AmiDatasourcePlugin.HELP_GENERAL,
			"Executed Command general help");

	private static final Map<String, String> OPTIONS_MAP = AmiShellAdapter.buildOptions();
