...
public abstract class AmiCenterBasicProcessor<A extends Message> extends BasicProcessor<A, AmiCenterState> implements AmiCenterProcessor<A, AmiCenterState> {
	...
	public AmiCenterBasicProcessor(Class<A> type) {
