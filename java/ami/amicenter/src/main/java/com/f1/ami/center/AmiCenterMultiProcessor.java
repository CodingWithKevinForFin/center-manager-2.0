...
public abstract class AmiCenterMultiProcessor<A extends Message> extends BasicProcessor<A, AmiCenterState>
		implements AmiCenterProcessor<A, AmiCenterState>, MultiProcessor<A, AmiCenterState> {
	...
	private final RequestOutputPort<AmiHdbRequest, AmiHdbResponse> oHdbReqResPort = newRequestOutputPort(AmiHdbRequest.class, AmiHdbResponse.class);

	public AmiCenterMultiProcessor(Class<A> type) {
		super(type, AmiCenterState.class);
