...
public class AmiPreparedCell_Int extends AmiPreparedCell {
	private int value;
	boolean isNull = false;

	public AmiPreparedCell_Int(AmiColumn column, boolean includeReserved) {
	...
	public void setComparable(Comparable value) {
		if (value == null)
			...
			this.value = Caster_Integer.INSTANCE.cast(value);
			this.isNull = false;
		}
	}
	@Override
