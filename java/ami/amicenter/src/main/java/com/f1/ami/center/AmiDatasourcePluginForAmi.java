...
public class AmiDatasourcePluginForAmi implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = AmiConsts.DATASOURCE_ADAPTER_NAME_AMI;
	private static final String DATASOURCE_DESC = "AMI Datasource";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "ami url help", AmiDatasourcePlugin.HELP_GENERAL, "ami general help");

	private static final Map<String, String> OPTIONS_MAP = Collections.EMPTY_MAP;
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		throw new UnsupportedOperationException("Unsupported Operation createDatasource() for class AmiDatasourcePluginForAmi");
	}
