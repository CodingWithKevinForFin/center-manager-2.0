...
public class AmiPreparedCell_UUID extends AmiPreparedCell {
	private UUID value;

	public AmiPreparedCell_UUID(AmiColumn column, boolean includeReserved) {
	...
	public void setComparable(Comparable value) {
		this.value = Caster_UUID.INSTANCE.cast(value);
	}
	@Override
	public void setNull() {
		this.value = null;
