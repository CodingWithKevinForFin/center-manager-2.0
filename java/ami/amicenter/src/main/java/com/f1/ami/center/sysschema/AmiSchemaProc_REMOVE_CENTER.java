...
public class AmiSchemaProc_REMOVE_CENTER extends AmiAbstractStoredProc {

	private static final String TYPE = "__SYSTEM";
	private static final String NAME = "__REMOVE_CENTER";
	...
	public AmiSchemaProc_REMOVE_CENTER(AmiImdbImpl imdb, CalcFrameStack sf) {
		this.imdb = imdb;
	...
	public FlowControl execute(AmiStoredProcRequest request, CalcFrameStack sf) throws Exception {
		...
		imdb.getReplicator().removeCenter(name, sf);
		return null;
	}
