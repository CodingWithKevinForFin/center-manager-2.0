...
public class AmiPreparedCell_Complex extends AmiPreparedCell {
	private Complex value;

	public AmiPreparedCell_Complex(AmiColumn column, boolean includeReserved) {
	...
	public void setString(String value) {
		this.value = SH.parseComplex(value);
	}
	@Override
	public void setComparable(Comparable value) {
		this.value = Caster_Complex.INSTANCE.cast(value);
	}
	@Override
	public void setNull() {
		this.value = null;
