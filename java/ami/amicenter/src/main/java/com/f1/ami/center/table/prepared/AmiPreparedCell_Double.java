...
public class AmiPreparedCell_Double extends AmiPreparedCell {
	private double value;
	boolean isNull = false;

	public AmiPreparedCell_Double(AmiColumn column, boolean includeReserved) {
	...
	public void setString(String value) {
		if (value == null)
			...
			this.value = SH.parseDouble(value);
			this.isNull = false;
		}
	}
	@Override
	public void setComparable(Comparable value) {
		if (value == null)
			...
			this.value = Caster_Double.INSTANCE.cast(value);
			this.isNull = false;
		}
	}
	@Override
