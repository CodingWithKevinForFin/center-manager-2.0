...
public class AmiCouchbaseDatasourcePlugin implements AmiDatasourcePlugin {

	private static final String DATASOURCE_TYPE = "COUCHBASE";
	private static final String DATASOURCE_DESC = "Couchbase";
	...
	private static final Map<String, Object> HELP_MAP = CH.m(AmiDatasourcePlugin.HELP_URL, "server_address[:port_number]", AmiDatasourcePlugin.HELP_GENERAL,
			"couchbase general help");
	private static final Map<String, String> OPTIONS_MAP = AmiCouchbaseDatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiCouchbaseDatasourceAdapter();
	}
