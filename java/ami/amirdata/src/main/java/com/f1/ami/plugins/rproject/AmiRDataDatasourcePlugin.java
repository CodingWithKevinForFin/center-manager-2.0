...
public class AmiRDataDatasourcePlugin implements AmiDatasourcePlugin {
	private static final String DATASOURCE_TYPE = "RData";
	private static final String DATASOURCE_DESC = "R Project";
	...
	private static final Map<String, String> OPTIONS_MAP = AmiRDataDatasourceAdapter.buildOptions();
	...
	public AmiDatasourceAdapter createDatasourceAdapter() {
		return new AmiRDataDatasourceAdapter();
	}
