...
/**
 * 
 * Attached to an {@link AmiClient} using the {@link AmiClient#addListener(AmiRawClientListener)}. Then the listener receives callbacks on interesting events from the client.
 * <P>
 ...
 * 
 */
public interface RawAmiClientListener {
	 ...
	 *            messsage (M=) contents
	 */
	public void onMessageReceived(RawAmiClient rawClient, long now, long seqnum, int status, CharSequence message);
	 ...
	 */
	public void onMessageSent(RawAmiClient rawClient, CharSequence message);
	 ...
	 *            represents the {@link AmiClient}'s internal connection to the AMI server
	 */
	public void onConnect(RawAmiClient rawClient);
	 ...
	 *            represents the {@link AmiClient}'s internal connection to the AMI server
	 */
	public void onDisconnect(RawAmiClient rawClient);
	 ...
	 */
	public void onCommand(RawAmiClient rawClient, String requestId, String cmd, String userName, String objectType, String objectId, Map<String, Object> params);
	 ...
	 *            represents the {@link AmiClient}'s internal connection to the AMI server
	 */
	public void onLoggedIn(RawAmiClient rawClient);
