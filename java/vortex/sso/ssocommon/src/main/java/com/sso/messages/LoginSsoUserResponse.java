...
public interface LoginSsoUserResponse extends SsoResponse {
	...
	byte STATUS_ACCOUNT_DISABLED = 6;
	byte STATUS_ACCOUNT_EXPIRED = 7;
	byte STATUS_ACCOUNT_RESTRICTION = 8;
	byte STATUS_INVALID_LOGON_HOURS = 9;
	byte STATUS_PASSWORD_EXPIRED = 10;
	byte STATUS_PASSWORD_MUST_CHANGE = 11;
	byte STATUS_ACCOUNT_LOCKED = 12;
	byte STATUS_PASSWORD_CHANGE_FAILED = 13;
	byte STATUS_USER_COUNT_EXCEEDED = 14;
