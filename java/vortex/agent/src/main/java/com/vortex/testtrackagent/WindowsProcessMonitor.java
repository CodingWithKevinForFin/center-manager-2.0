...
public class WindowsProcessMonitor {
	...
	public WindowsProcessMonitor(PropertyController propertyController) {
		init(propertyController);
	}

	private void init(PropertyController propertyController) {
		try {
			this.outputStream = System.out;
			this.inputStream = new LineNumberReader(new InputStreamReader(System.in));
		} catch (Exception e) {
