...
public abstract class VortexEyeRequestProcessor<A extends VortexEyeRequest, B extends Message> extends BasicRequestProcessor<A, VortexEyeState, B> implements
		VortexEyeProcessor<RequestMessage<A>> {
	...
	public VortexEyeRequestProcessor(Class<A> type, Class<B> resultType) {
		super(type, VortexEyeState.class, resultType);
