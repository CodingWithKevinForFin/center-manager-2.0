...
public abstract class VortexEyeResultProcessor<A extends Message> extends BasicResultProcessor<A, VortexEyeState> implements VortexEyeProcessor<ResultMessage<A>> {
	...
	public VortexEyeResultProcessor(Class<A> type) {
	...
	public String getProcessUidFromAgentResponse(ResultMessage<?> result) {
		VortexAgentRequest req = (VortexAgentRequest) result.getRequestMessage().getAction();
