...
public class SjlsIdGenerator implements IdGenerator<String>, NamespaceIdGenerator<String> {
	...
	public SjlsIdGenerator(Formatter formatter, Clock clock, String systemName, NamespaceIdGenerator<Long> generator) {
