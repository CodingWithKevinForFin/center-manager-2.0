...
import com.f1.anvil.triggers.AnvilTriggerChildOrder;
import com.f1.container.ContainerTools;
import com.f1.utils.PropertyController;

public class AnvilTriggerFactory_ChildOrder implements AmiTriggerFactory {
	...
	public AmiTrigger newTrigger() {
		return new AnvilTriggerChildOrder();
	}
