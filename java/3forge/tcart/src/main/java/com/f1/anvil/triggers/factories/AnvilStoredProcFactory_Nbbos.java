...
import com.f1.anvil.triggers.AnvilStoredProcQueryNbbos;
import com.f1.container.ContainerTools;
import com.f1.utils.PropertyController;

public class AnvilStoredProcFactory_Nbbos implements AmiStoredProcFactory {
	...
	public AmiStoredProc newStoredProc() {
		return new AnvilStoredProcQueryNbbos();
	}
