...
import com.f1.anvil.triggers.AnvilTriggerExecution;
import com.f1.container.ContainerTools;
import com.f1.utils.PropertyController;

public class AnvilTriggerFactory_Execution implements AmiTriggerFactory {
	...
	public AmiTrigger newTrigger() {
		return new AnvilTriggerExecution();
	}
