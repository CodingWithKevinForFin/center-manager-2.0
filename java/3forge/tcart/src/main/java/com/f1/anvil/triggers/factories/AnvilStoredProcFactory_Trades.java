...
import com.f1.anvil.triggers.AnvilStoredProcQueryTrades;
import com.f1.container.ContainerTools;
import com.f1.utils.PropertyController;

public class AnvilStoredProcFactory_Trades implements AmiStoredProcFactory {
	...
	public AmiStoredProc newStoredProc() {
		return new AnvilStoredProcQueryTrades();
	}
