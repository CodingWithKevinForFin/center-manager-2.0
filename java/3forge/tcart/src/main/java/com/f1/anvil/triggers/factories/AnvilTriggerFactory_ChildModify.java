...
import com.f1.anvil.triggers.AnvilTriggerChildModify;
import com.f1.container.ContainerTools;
import com.f1.utils.PropertyController;

public class AnvilTriggerFactory_ChildModify implements AmiTriggerFactory {
	...
	public AmiTrigger newTrigger() {
		return new AnvilTriggerChildModify();
	}
