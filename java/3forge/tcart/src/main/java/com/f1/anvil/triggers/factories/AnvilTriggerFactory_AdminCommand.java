...
import com.f1.anvil.triggers.AnvilTriggerAdminCommand;
import com.f1.container.ContainerTools;
import com.f1.utils.PropertyController;

public class AnvilTriggerFactory_AdminCommand implements AmiTriggerFactory {
	...
	public AmiTrigger newTrigger() {
		return new AnvilTriggerAdminCommand();
	}
