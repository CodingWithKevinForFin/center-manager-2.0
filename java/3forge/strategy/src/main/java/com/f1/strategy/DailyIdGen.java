...
public class DailyIdGen implements IdGenerator<String>, NamespaceIdGenerator<String> {
	...
	public DailyIdGen(Formatter formatter, Clock clock, String systemName, NamespaceIdGenerator<Long> generator) {
