...
public class ShowParentExecutionsInterPortletMessage implements InterPortletMessage {

	final private List<WebOmsOrder> showExecutions, hideExecutions;

	public ShowParentExecutionsInterPortletMessage(List<WebOmsOrder> showExecutions, List<WebOmsOrder> hideExecutions) {
