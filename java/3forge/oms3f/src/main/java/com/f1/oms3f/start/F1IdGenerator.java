...
public class F1IdGenerator implements IdGenerator<String>, NamespaceIdGenerator<String> {
	...
	public F1IdGenerator(Formatter formatter, Clock clock, String systemName, NamespaceIdGenerator<Long> generator) {
