...
public class WebTreeFilteredInFilter implements WebTreeFilter {
	TextMatcherFactory MATCHER_FACTORY = new TextMatcherFactory(true, false, false);

	private static final TextMatcher[] EMPTY = new TextMatcher[0];
	final private FastWebTreeColumn column;
	...
	final private WebTreeNodeFormatter formatter;
	...
	public WebTreeFilteredInFilter(FastWebTreeColumn column) {
		this.column = column;
		this.formatter = column.getFormatter();
	}

	@Override
	public boolean shouldKeep(WebTreeNode row) {
		Object data;
		...
		if (minNum != null || maxNum != null || numberValues != null) {
			Comparable value = (Comparable) data;//formatter.getValue(column, data);
	...
	private CharSequence formatData(Object data) {
		return formatter.formatToText(data);
	}
	...
	public WebTreeFilteredInFilter setValues(Set<String> filterIn, boolean isPattern) {
		this.values.clear();
	...
	public WebTreeFilteredInFilter setIncludeNull(boolean includeNull) {
	...
	public WebTreeFilteredInFilter setMax(boolean inclusive, String max) {
	...
	public WebTreeFilteredInFilter setMin(boolean inclusive, String min) {
	...
	public WebTreeFilteredInFilter setKeep(boolean keep) {
		this.keep = keep;
		return this;
	}
	...
	public boolean equals(Object obj) {
		if (obj == null || obj.getClass() != WebTreeFilteredInFilter.class)
			return false;
		WebTreeFilteredInFilter other = (WebTreeFilteredInFilter) obj;
	...
	public void getConfig(HashMap<String, Object> sink) {
		CH.mSkipNull(sink, "value", this.values, "min", this.min, "isMinInclusive", this.minInclusive, "isMaxInclusive", this.maxInclusive, "max", this.max, "isPattern",
				this.isPattern, "includeNull", this.includeNull, "isKeep", this.keep, "isMaxInclusive", this.maxInclusive);
	}
}
