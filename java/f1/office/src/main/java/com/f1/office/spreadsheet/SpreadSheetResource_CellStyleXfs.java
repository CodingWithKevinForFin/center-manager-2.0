...
public class SpreadSheetResource_CellStyleXfs extends SpreadSheetResource {

	private static final String XML_NAME = "xf";

	public SpreadSheetResource_CellStyleXfs() {
		this.setXml(createDefaultXml());
	}

	public SpreadSheetResource_CellStyleXfs(XmlElement e) {
		this.setXml(e);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SpreadSheetResource_CellStyleXfs other = (SpreadSheetResource_CellStyleXfs) obj;
