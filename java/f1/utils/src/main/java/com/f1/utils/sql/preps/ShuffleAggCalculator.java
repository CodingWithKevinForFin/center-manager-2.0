...
public class ShuffleAggCalculator extends AbstractPrepCalculator {
	public static final String METHOD_NAME = "shuffle";
	...
	public final static PrepMethodFactory FACTORY = new PrepMethodFactory() {
		...
		public AbstractPrepCalculator toMethod(int position, String methodName, DerivedCellCalculator[] calcs, com.f1.utils.structs.table.stack.CalcTypesStack context) {
			return new ShuffleAggCalculator(position, calcs[0]);
		}
	};
	...
	public ShuffleAggCalculator(int position, DerivedCellCalculator inner) {
	...
	public DerivedCellCalculator copy() {
		return new ShuffleAggCalculator(getPosition(), inner.copy());
	}
	@Override
