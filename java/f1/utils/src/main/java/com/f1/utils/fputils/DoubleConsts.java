...
/**
 * This class contains additional constants documenting limits of the <code>double</code> type.
 *
...
public class DoubleConsts {
	...
	/**
	 * A constant holding the smallest positive normal value of type <code>double</code>, 2<sup>-1022</sup>. It is equal to the value returned by
	...
	/**
	 * The exponent the smallest positive <code>double</code> subnormal value would have if it could be normalized. It is equal to the value returned by
	...
	static {
		...
		assert (((SIGN_BIT_MASK | EXP_BIT_MASK | SIGNIF_BIT_MASK) == ~0L)
				&& (((SIGN_BIT_MASK & EXP_BIT_MASK) == 0L) && ((SIGN_BIT_MASK & SIGNIF_BIT_MASK) == 0L) && ((EXP_BIT_MASK & SIGNIF_BIT_MASK) == 0L)));
	}
}