...
public class ColumnarColumnString_CompactAscii extends ColumnarColumn<String> {

	private StringArrayList_Bytes strings = new StringArrayList_Bytes();

	public ColumnarColumnString_CompactAscii(ColumnsTable table, int location, String id, int capacity, boolean allowNull) {
	...
	public long getMemorySize() {
		return this.strings.getDataSize();
	}
