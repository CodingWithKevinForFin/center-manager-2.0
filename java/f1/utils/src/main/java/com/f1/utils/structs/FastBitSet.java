...
public class FastBitSet extends BitSet {
	...
	public boolean equals(Object obj) {
		...
		if (obj == this)
			return true;
		if (obj.getClass() != FastBitSet.class)
			return false;
		return Arrays.equals(bits, ((FastBitSet) obj).bits);
	}
	...
	public FastBitSet(boolean[] bits) {
		this.bits = bits;
	}

	public FastBitSet(int[] bitsSet) {
