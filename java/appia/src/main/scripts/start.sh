...
APPCLASS=com.f1.appia.StartAppiaMain
...
java  -Df1.license.mode=dev\
      ...
      -Dproperty.f1.logging.mode=\
         -Df1.bootstrap.main=com.javtech.appia.middleware.inproc.AppiaInProcLauncher\
         -Dcom.javtech.appia.javatoolkit.middleware.LogClass=com.f1.appia.AppiaSpeedLogger\
         ${JAVA_OPTIONS}\
        $* -classpath $CP $APPCLASS com.javtech.simulator.Simulator config/simulator.xml 2> log/stderr.log i> /dev/null &
