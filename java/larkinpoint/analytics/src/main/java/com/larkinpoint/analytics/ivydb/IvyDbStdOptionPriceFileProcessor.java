...
public class IvyDbStdOptionPriceFileProcessor extends BasicProcessor<LoadFileMessage, LarkinPointState> {

	private File basePath;
	private boolean skipFirstRow;

	public IvyDbStdOptionPriceFileProcessor() {
			...
			try {
				...
				for (int i = 0; i < lines.length - 1; i++) {
					...
					try {
						...
						dbservice.execute("insert_ivy_std_option_price", params, connection);
					} catch (Exception e) {
