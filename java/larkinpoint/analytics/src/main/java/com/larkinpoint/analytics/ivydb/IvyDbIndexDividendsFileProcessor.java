...
public class IvyDbIndexDividendsFileProcessor extends BasicProcessor<LoadFileMessage, LarkinPointState> {

	private File basePath;
	private boolean skipFirstRow;

	public IvyDbIndexDividendsFileProcessor() {
			...
			try {
				...
				for (int i = 0; i < lines.length - 1; i++) {
					...
					try {
						...
						dbservice.execute("insert_ivy_index_dividends_data", params, connection);
					} catch (Exception e) {
