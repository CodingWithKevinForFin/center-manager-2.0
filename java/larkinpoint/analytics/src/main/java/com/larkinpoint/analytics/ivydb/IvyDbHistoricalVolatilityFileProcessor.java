...
public class IvyDbHistoricalVolatilityFileProcessor extends BasicProcessor<LoadFileMessage, LarkinPointState> {

	private File basePath;
	private boolean skipFirstRow;

	public IvyDbHistoricalVolatilityFileProcessor() {
			...
			try {
				...
				for (int i = 0; i < lines.length - 1; i++) {
					...
					try {
						...
						dbservice.execute("insert_ivy_historical_volatility_data", params, connection);
					} catch (Exception e) {
