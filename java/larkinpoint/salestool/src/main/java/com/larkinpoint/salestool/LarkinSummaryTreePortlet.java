...
public class LarkinSummaryTreePortlet extends FastTreePortlet implements WebTreeContextMenuListener, WebTreeContextMenuFactory, Comparator<WebTreeNode> {

	private LarkinParameters params;

	public LarkinSummaryTreePortlet(PortletConfig portletConfig, LarkinParameters params) {
		super(portletConfig);
